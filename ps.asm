   ...
   9:	31 c0                	xor    %eax,%eax
{
  ...
  1d:	3d 00 ca 9a 3b       	cmp    $0x3b9aca00,%eax
  22:	75 f4                	jne    18 <main+0x18>
	printf(1, "%d\n", sum);
  24:	83 ec 04             	sub    $0x4,%esp
  27:	52                   	push   %edx
  28:	68 28 07 00 00       	push   $0x728
  2d:	6a 01                	push   $0x1
 ...
 409:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 479:	ff 24 85 34 07 00 00 	jmp    *0x734(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 587:	90                   	nop
          s = "(null)";
 588:	ba 2c 07 00 00       	mov    $0x72c,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5a1:	a1 34 0a 00 00       	mov    0xa34,%eax
{
 ...
 5e1:	5b                   	pop    %ebx
  freep = p;
 5e2:	89 15 34 0a 00 00    	mov    %edx,0xa34
}
 5e8:	5e                   	pop    %esi
 5e9:	5f                   	pop    %edi
 5ea:	5d                   	pop    %ebp
 ...
 619:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 61c:	89 15 34 0a 00 00    	mov    %edx,0xa34
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 639:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 63c:	8b 3d 34 0a 00 00    	mov    0xa34,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 67f:	73 4f                	jae    6d0 <malloc+0xa0>
    ...
    if(p == freep)
 681:	8b 3d 34 0a 00 00    	mov    0xa34,%edi
 ...
 6aa:	e8 f1 fe ff ff       	call   5a0 <free>
  return freep;
 6af:	8b 15 34 0a 00 00    	mov    0xa34,%edx
 ...
 6dc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6df:	89 15 34 0a 00 00    	mov    %edx,0xa34
}
 ...
 6ef:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 6f0:	c7 05 34 0a 00 00 38 	movl   $0xa38,0xa34
 6f7:	0a 00 00 
    base.s.size = 0;
 6fa:	bf 38 0a 00 00       	mov    $0xa38,%edi
    base.s.ptr = freep = prevp = &base;
 6ff:	c7 05 38 0a 00 00 38 	movl   $0xa38,0xa38
 706:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 709:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 70b:	c7 05 3c 0a 00 00 00 	movl   $0x0,0xa3c
 712:	00 00 00 
    if(p->s.size >= nunits){
