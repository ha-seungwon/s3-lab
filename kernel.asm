...
80100028:	bc d0 55 11 80       	mov    $0x801155d0,%esp
  ...
  # for a direct jump.
  mov $main, %eax
8010002d:	b8 60 31 10 80       	mov    $0x80103160,%eax
  jmp *%eax
...
8010018c:	e8 4f 22 00 00       	call   801023e0 <iderw>
...
801001d3:	c9                   	leave  
  iderw(b);
801001d4:	e9 07 22 00 00       	jmp    801023e0 <iderw>
    panic("bwrite");
...
80100a96:	00 00 00 
  ioapicenable(IRQ_KBD, 0);
80100a99:	e8 e2 1a 00 00       	call   80102580 <ioapicenable>
}
...
80100ac1:	89 85 ec fe ff ff    	mov    %eax,-0x114(%ebp)
  ...
  begin_op();
80100ac7:	e8 94 23 00 00       	call   80102e60 <begin_op>
...
80100b0a:	e8 01 0f 00 00       	call   80101a10 <iunlockput>
    end_op();
80100b0f:	e8 bc 23 00 00       	call   80102ed0 <end_op>
...
80100c4c:	e8 bf 0d 00 00       	call   80101a10 <iunlockput>
  end_op();
80100c51:	e8 7a 22 00 00       	call   80102ed0 <end_op>
  if((sz = allocuvm(pgdir, sz, sz + 2*PGSIZE)) == 0)
...
80100ddf:	e9 38 fd ff ff       	jmp    80100b1c <exec+0x6c>
    end_op();
80100de4:	e8 e7 20 00 00       	call   80102ed0 <end_op>
    cprintf("exec: fail\n");
...
80100f77:	90                   	nop
    begin_op();
80100f78:	e8 e3 1e 00 00       	call   80102e60 <begin_op>
    iput(ff.ip);
...
80100f91:	5d                   	pop    %ebp
    end_op();
80100f92:	e9 39 1f 00 00       	jmp    80102ed0 <end_op>
...
80100fa9:	e8 82 26 00 00       	call   80103630 <pipeclose>
...
8010108c:	5d                   	pop    %ebp
    return piperead(f->pipe, addr, n);
8010108d:	e9 3e 27 00 00       	jmp    801037d0 <piperead>
...
80101104:	e8 57 07 00 00       	call   80101860 <iunlock>
      end_op();
80101109:	e8 c2 1d 00 00       	call   80102ed0 <end_op>
...
8010112b:	0f 4f f8             	cmovg  %eax,%edi
      begin_op();
8010112e:	e8 2d 1d 00 00       	call   80102e60 <begin_op>
      ilock(f->ip);
...
80101160:	e8 fb 06 00 00       	call   80101860 <iunlock>
      end_op();
80101165:	e8 66 1d 00 00       	call   80102ed0 <end_op>
      if(r < 0)
...
801011a8:	5d                   	pop    %ebp
    return pipewrite(f->pipe, addr, n);
801011a9:	e9 22 25 00 00       	jmp    801036d0 <pipewrite>
  panic("filewrite");
...
8010120d:	e8 2e 1e 00 00       	call   80103040 <log_write>
  brelse(bp);
...
801012fd:	e8 3e 1d 00 00       	call   80103040 <log_write>
        brelse(bp);
...
8010132d:	e8 0e 1d 00 00       	call   80103040 <log_write>
  brelse(bp);
...
801014c5:	e8 76 1b 00 00       	call   80103040 <log_write>
...
801015f3:	68 f4 74 10 80       	push   $0x801074f4
...
801016a0:	e8 9b 19 00 00       	call   80103040 <log_write>
      brelse(bp);
...
80101739:	e8 02 19 00 00       	call   80103040 <log_write>
  brelse(bp);
...
80101c3b:	e8 00 14 00 00       	call   80103040 <log_write>
    brelse(bp);
...
80101da4:	0f 84 64 01 00 00    	je     80101f0e <namex+0x17e>
    ...
    ip = idup(myproc()->cwd);
80101daa:	e8 c1 1c 00 00       	call   80103a70 <myproc>
  acquire(&icache.lock);
...
80102088:	68 e6 7a 10 80       	push   $0x80107ae6
...
801020d4:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
801020ec:	3d ab 84 01 00       	cmp    $0x184ab,%eax
801020f1:	77 55                	ja     80102148 <swapread+0x68>
		panic("swapread: blkno exceed range");

	for ( i=0; i < 8; ++i ) {
		bp = bread(0, blkno + SWAPBASE + i);
801020f3:	8d b8 f4 01 00 00    	lea    0x1f4(%eax),%edi
801020f9:	05 fc 01 00 00       	add    $0x1fc,%eax
801020fe:	8b 75 08             	mov    0x8(%ebp),%esi
80102101:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80102104:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80102108:	83 ec 08             	sub    $0x8,%esp
8010210b:	57                   	push   %edi
	for ( i=0; i < 8; ++i ) {
8010210c:	83 c7 01             	add    $0x1,%edi
		bp = bread(0, blkno + SWAPBASE + i);
8010210f:	6a 00                	push   $0x0
80102111:	e8 ba df ff ff       	call   801000d0 <bread>
		memmove(ptr + i * BSIZE, bp->data, BSIZE);
80102116:	83 c4 0c             	add    $0xc,%esp
		bp = bread(0, blkno + SWAPBASE + i);
80102119:	89 c3                	mov    %eax,%ebx
		memmove(ptr + i * BSIZE, bp->data, BSIZE);
8010211b:	8d 40 5c             	lea    0x5c(%eax),%eax
8010211e:	68 00 02 00 00       	push   $0x200
80102123:	50                   	push   %eax
80102124:	56                   	push   %esi
	for ( i=0; i < 8; ++i ) {
80102125:	81 c6 00 02 00 00    	add    $0x200,%esi
		memmove(ptr + i * BSIZE, bp->data, BSIZE);
8010212b:	e8 00 27 00 00       	call   80104830 <memmove>
		brelse(bp);
80102130:	89 1c 24             	mov    %ebx,(%esp)
80102133:	e8 b8 e0 ff ff       	call   801001f0 <brelse>
	for ( i=0; i < 8; ++i ) {
80102138:	83 c4 10             	add    $0x10,%esp
8010213b:	3b 7d e4             	cmp    -0x1c(%ebp),%edi
8010213e:	75 c8                	jne    80102108 <swapread+0x28>
	}
}
...
8010214b:	68 d5 74 10 80       	push   $0x801074d5
80102150:	e8 2b e2 ff ff       	call   80100380 <panic>
80102155:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
80102169:	8b 45 0c             	mov    0xc(%ebp),%eax
	...
	if ( blkno < 0 || blkno >= SWAPMAX )
8010216c:	3d ab 84 01 00       	cmp    $0x184ab,%eax
80102171:	77 5d                	ja     801021d0 <swapwrite+0x70>
		panic("swapread: blkno exceed range");

	for ( i=0; i < 8; ++i ) {
		bp = bread(0, blkno + SWAPBASE + i);
80102173:	8d b8 f4 01 00 00    	lea    0x1f4(%eax),%edi
80102179:	05 fc 01 00 00       	add    $0x1fc,%eax
8010217e:	8b 75 08             	mov    0x8(%ebp),%esi
80102181:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80102184:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80102188:	83 ec 08             	sub    $0x8,%esp
8010218b:	57                   	push   %edi
	for ( i=0; i < 8; ++i ) {
8010218c:	83 c7 01             	add    $0x1,%edi
		bp = bread(0, blkno + SWAPBASE + i);
8010218f:	6a 00                	push   $0x0
80102191:	e8 3a df ff ff       	call   801000d0 <bread>
		memmove(bp->data, ptr + i * BSIZE, BSIZE);
80102196:	83 c4 0c             	add    $0xc,%esp
		bp = bread(0, blkno + SWAPBASE + i);
80102199:	89 c3                	mov    %eax,%ebx
		memmove(bp->data, ptr + i * BSIZE, BSIZE);
8010219b:	8d 40 5c             	lea    0x5c(%eax),%eax
8010219e:	68 00 02 00 00       	push   $0x200
801021a3:	56                   	push   %esi
	for ( i=0; i < 8; ++i ) {
801021a4:	81 c6 00 02 00 00    	add    $0x200,%esi
		memmove(bp->data, ptr + i * BSIZE, BSIZE);
801021aa:	50                   	push   %eax
801021ab:	e8 80 26 00 00       	call   80104830 <memmove>
		bwrite(bp);
801021b0:	89 1c 24             	mov    %ebx,(%esp)
801021b3:	e8 f8 df ff ff       	call   801001b0 <bwrite>
		brelse(bp);
801021b8:	89 1c 24             	mov    %ebx,(%esp)
801021bb:	e8 30 e0 ff ff       	call   801001f0 <brelse>
	for ( i=0; i < 8; ++i ) {
801021c0:	83 c4 10             	add    $0x10,%esp
801021c3:	3b 7d e4             	cmp    -0x1c(%ebp),%edi
801021c6:	75 c0                	jne    80102188 <swapwrite+0x28>
	}
}
...
801021d3:	68 d5 74 10 80       	push   $0x801074d5
801021d8:	e8 a3 e1 ff ff       	call   80100380 <panic>
801021dd:	66 90                	xchg   %ax,%ax
801021df:	90                   	nop
...
8010229b:	68 50 75 10 80       	push   $0x80107550
801022a0:	e8 db e0 ff ff       	call   80100380 <panic>
    panic("idestart");
801022a5:	83 ec 0c             	sub    $0xc,%esp
801022a8:	68 47 75 10 80       	push   $0x80107547
...
801022c6:	68 62 75 10 80       	push   $0x80107562
801022cb:	68 00 16 11 80       	push   $0x80111600
801022d0:	e8 2b 22 00 00       	call   80104500 <initlock>
...
80102318:	74 f6                	je     80102310 <ideinit+0x50>
      havedisk1 = 1;
8010231a:	c7 05 e0 15 11 80 01 	movl   $0x1,0x801115e0
80102321:	00 00 00 
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
...
80102346:	83 ec 18             	sub    $0x18,%esp
  ...
  acquire(&idelock);
80102349:	68 00 16 11 80       	push   $0x80111600
8010234e:	e8 7d 23 00 00       	call   801046d0 <acquire>

  if((b = idequeue) == 0){
80102353:	8b 1d e4 15 11 80    	mov    0x801115e4,%ebx
80102359:	83 c4 10             	add    $0x10,%esp
8010235c:	85 db                	test   %ebx,%ebx
8010235e:	74 63                	je     801023c3 <ideintr+0x83>
    release(&idelock);
    return;
  }
  idequeue = b->qnext;
80102360:	8b 43 58             	mov    0x58(%ebx),%eax
80102363:	a3 e4 15 11 80       	mov    %eax,0x801115e4

  // Read data if needed.
  if(!(b->flags & B_DIRTY) && idewait(1) >= 0)
80102368:	8b 33                	mov    (%ebx),%esi
8010236a:	f7 c6 04 00 00 00    	test   $0x4,%esi
80102370:	75 2f                	jne    801023a1 <ideintr+0x61>
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
...
80102380:	ec                   	in     (%dx),%al
  while(((r = inb(0x1f7)) & (IDE_BSY|IDE_DRDY)) != IDE_DRDY)
80102381:	89 c1                	mov    %eax,%ecx
80102383:	83 e1 c0             	and    $0xffffffc0,%ecx
80102386:	80 f9 40             	cmp    $0x40,%cl
80102389:	75 f5                	jne    80102380 <ideintr+0x40>
  if(checkerr && (r & (IDE_DF|IDE_ERR)) != 0)
8010238b:	a8 21                	test   $0x21,%al
8010238d:	75 12                	jne    801023a1 <ideintr+0x61>
    insl(0x1f0, b->data, BSIZE/4);
8010238f:	8d 7b 5c             	lea    0x5c(%ebx),%edi
  asm volatile("cld; rep insl" :
80102392:	b9 80 00 00 00       	mov    $0x80,%ecx
80102397:	ba f0 01 00 00       	mov    $0x1f0,%edx
8010239c:	fc                   	cld    
8010239d:	f3 6d                	rep insl (%dx),%es:(%edi)

  // Wake process waiting for this buf.
  b->flags |= B_VALID;
8010239f:	8b 33                	mov    (%ebx),%esi
  b->flags &= ~B_DIRTY;
801023a1:	83 e6 fb             	and    $0xfffffffb,%esi
  wakeup(b);
801023a4:	83 ec 0c             	sub    $0xc,%esp
  b->flags &= ~B_DIRTY;
801023a7:	83 ce 02             	or     $0x2,%esi
801023aa:	89 33                	mov    %esi,(%ebx)
  wakeup(b);
801023ac:	53                   	push   %ebx
801023ad:	e8 7e 1e 00 00       	call   80104230 <wakeup>

  // Start disk on next buf in queue.
  if(idequeue != 0)
801023b2:	a1 e4 15 11 80       	mov    0x801115e4,%eax
801023b7:	83 c4 10             	add    $0x10,%esp
801023ba:	85 c0                	test   %eax,%eax
801023bc:	74 05                	je     801023c3 <ideintr+0x83>
    idestart(idequeue);
801023be:	e8 1d fe ff ff       	call   801021e0 <idestart>
    release(&idelock);
801023c3:	83 ec 0c             	sub    $0xc,%esp
801023c6:	68 00 16 11 80       	push   $0x80111600
801023cb:	e8 a0 22 00 00       	call   80104670 <release>
...
801023ee:	e8 bd 20 00 00       	call   801044b0 <holdingsleep>
801023f3:	83 c4 10             	add    $0x10,%esp
801023f6:	85 c0                	test   %eax,%eax
801023f8:	0f 84 c3 00 00 00    	je     801024c1 <iderw+0xe1>
    panic("iderw: buf not locked");
  if((b->flags & (B_VALID|B_DIRTY)) == B_VALID)
801023fe:	8b 03                	mov    (%ebx),%eax
80102400:	83 e0 06             	and    $0x6,%eax
80102403:	83 f8 02             	cmp    $0x2,%eax
80102406:	0f 84 a8 00 00 00    	je     801024b4 <iderw+0xd4>
    panic("iderw: nothing to do");
  if(b->dev != 0 && !havedisk1)
8010240c:	8b 53 04             	mov    0x4(%ebx),%edx
8010240f:	85 d2                	test   %edx,%edx
80102411:	74 0d                	je     80102420 <iderw+0x40>
80102413:	a1 e0 15 11 80       	mov    0x801115e0,%eax
80102418:	85 c0                	test   %eax,%eax
8010241a:	0f 84 87 00 00 00    	je     801024a7 <iderw+0xc7>
    panic("iderw: ide disk 1 not present");

  acquire(&idelock);  //DOC:acquire-lock
80102420:	83 ec 0c             	sub    $0xc,%esp
80102423:	68 00 16 11 80       	push   $0x80111600
80102428:	e8 a3 22 00 00       	call   801046d0 <acquire>

  // Append b to idequeue.
  b->qnext = 0;
  for(pp=&idequeue; *pp; pp=&(*pp)->qnext)  //DOC:insert-queue
8010242d:	a1 e4 15 11 80       	mov    0x801115e4,%eax
  b->qnext = 0;
80102432:	c7 43 58 00 00 00 00 	movl   $0x0,0x58(%ebx)
  for(pp=&idequeue; *pp; pp=&(*pp)->qnext)  //DOC:insert-queue
80102439:	83 c4 10             	add    $0x10,%esp
8010243c:	85 c0                	test   %eax,%eax
8010243e:	74 60                	je     801024a0 <iderw+0xc0>
80102440:	89 c2                	mov    %eax,%edx
80102442:	8b 40 58             	mov    0x58(%eax),%eax
80102445:	85 c0                	test   %eax,%eax
80102447:	75 f7                	jne    80102440 <iderw+0x60>
80102449:	83 c2 58             	add    $0x58,%edx
    ;
  *pp = b;
8010244c:	89 1a                	mov    %ebx,(%edx)

  // Start disk if necessary.
  if(idequeue == b)
8010244e:	39 1d e4 15 11 80    	cmp    %ebx,0x801115e4
80102454:	74 3a                	je     80102490 <iderw+0xb0>
    idestart(b);

  // Wait for request to finish.
  while((b->flags & (B_VALID|B_DIRTY)) != B_VALID){
80102456:	8b 03                	mov    (%ebx),%eax
80102458:	83 e0 06             	and    $0x6,%eax
8010245b:	83 f8 02             	cmp    $0x2,%eax
8010245e:	74 1b                	je     8010247b <iderw+0x9b>
    sleep(b, &idelock);
80102460:	83 ec 08             	sub    $0x8,%esp
80102463:	68 00 16 11 80       	push   $0x80111600
80102468:	53                   	push   %ebx
80102469:	e8 02 1d 00 00       	call   80104170 <sleep>
  while((b->flags & (B_VALID|B_DIRTY)) != B_VALID){
8010246e:	8b 03                	mov    (%ebx),%eax
80102470:	83 c4 10             	add    $0x10,%esp
80102473:	83 e0 06             	and    $0x6,%eax
80102476:	83 f8 02             	cmp    $0x2,%eax
80102479:	75 e5                	jne    80102460 <iderw+0x80>
  }


  release(&idelock);
8010247b:	c7 45 08 00 16 11 80 	movl   $0x80111600,0x8(%ebp)
}
80102482:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80102485:	c9                   	leave  
  release(&idelock);
80102486:	e9 e5 21 00 00       	jmp    80104670 <release>
8010248b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
8010248f:	90                   	nop
    idestart(b);
80102490:	89 d8                	mov    %ebx,%eax
80102492:	e8 49 fd ff ff       	call   801021e0 <idestart>
80102497:	eb bd                	jmp    80102456 <iderw+0x76>
80102499:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  for(pp=&idequeue; *pp; pp=&(*pp)->qnext)  //DOC:insert-queue
801024a0:	ba e4 15 11 80       	mov    $0x801115e4,%edx
801024a5:	eb a5                	jmp    8010244c <iderw+0x6c>
    panic("iderw: ide disk 1 not present");
801024a7:	83 ec 0c             	sub    $0xc,%esp
801024aa:	68 91 75 10 80       	push   $0x80107591
801024af:	e8 cc de ff ff       	call   80100380 <panic>
    panic("iderw: nothing to do");
801024b4:	83 ec 0c             	sub    $0xc,%esp
801024b7:	68 7c 75 10 80       	push   $0x8010757c
801024bc:	e8 bf de ff ff       	call   80100380 <panic>
    panic("iderw: buf not locked");
801024c1:	83 ec 0c             	sub    $0xc,%esp
801024c4:	68 66 75 10 80       	push   $0x80107566
801024c9:	e8 b2 de ff ff       	call   80100380 <panic>
...
801024d1:	c7 05 34 16 11 80 00 	movl   $0xfec00000,0x80111634
801024d8:	00 c0 fe 
{
...
801024e6:	00 00 00 
  return ioapic->data;
801024e9:	8b 15 34 16 11 80    	mov    0x80111634,%edx
801024ef:	8b 72 10             	mov    0x10(%edx),%esi
  ioapic->reg = reg;
801024f2:	c7 02 00 00 00 00    	movl   $0x0,(%edx)
  return ioapic->data;
801024f8:	8b 0d 34 16 11 80    	mov    0x80111634,%ecx
  maxintr = (ioapicread(REG_VER) >> 16) & 0xFF;
  id = ioapicread(REG_ID) >> 24;
  if(id != ioapicid)
801024fe:	0f b6 15 80 17 11 80 	movzbl 0x80111780,%edx
  maxintr = (ioapicread(REG_VER) >> 16) & 0xFF;
...
8010251a:	68 b0 75 10 80       	push   $0x801075b0
8010251f:	e8 7c e1 ff ff       	call   801006a0 <cprintf>
  ioapic->reg = reg;
80102524:	8b 0d 34 16 11 80    	mov    0x80111634,%ecx
...
8010255c:	89 19                	mov    %ebx,(%ecx)
  ioapic->data = data;
8010255e:	8b 0d 34 16 11 80    	mov    0x80111634,%ecx
...
801025d2:	81 fb d0 55 11 80    	cmp    $0x801155d0,%ebx
...
801025f2:	e8 99 21 00 00       	call   80104790 <memset>
...
80102628:	e8 a3 20 00 00       	call   801046d0 <acquire>
...
80102642:	c9                   	leave  
    release(&kmem.lock);
80102643:	e9 28 20 00 00       	jmp    80104670 <release>
    panic("kfree");
80102648:	83 ec 0c             	sub    $0xc,%esp
8010264b:	68 e2 75 10 80       	push   $0x801075e2
...
8010271b:	68 e8 75 10 80       	push   $0x801075e8
80102720:	68 40 16 11 80       	push   $0x80111640
80102725:	e8 d6 1d 00 00       	call   80104500 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
801027ab:	83 ec 24             	sub    $0x24,%esp
    acquire(&kmem.lock);
801027ae:	68 40 16 11 80       	push   $0x80111640
801027b3:	e8 18 1f 00 00       	call   801046d0 <acquire>
  r = kmem.freelist;
801027b8:	a1 78 16 11 80       	mov    0x80111678,%eax
  if(kmem.use_lock)
801027bd:	8b 15 74 16 11 80    	mov    0x80111674,%edx
  if(r)
...
801027cc:	89 0d 78 16 11 80    	mov    %ecx,0x80111678
  if(kmem.use_lock)
...
801027dc:	68 40 16 11 80       	push   $0x80111640
801027e1:	e8 8a 1e 00 00       	call   80104670 <release>
  return (char*)r;
...
80102807:	ec                   	in     (%dx),%al
  ...
  if(data == 0xE0){
    shift |= E0ESC;
80102808:	8b 1d 7c 16 11 80    	mov    0x8011167c,%ebx
  data = inb(KBDATAP);
...
8010282b:	0f b6 91 20 77 10 80 	movzbl -0x7fef88e0(%ecx),%edx
  shift ^= togglecode[data];
80102832:	0f b6 81 20 76 10 80 	movzbl -0x7fef89e0(%ecx),%eax
  shift |= shiftcode[data];
...
8010283d:	89 d0                	mov    %edx,%eax
  shift ^= togglecode[data];
8010283f:	89 15 7c 16 11 80    	mov    %edx,0x8011167c
  c = charcode[shift & (CTL | SHIFT)][data];
80102845:	83 e0 03             	and    $0x3,%eax
  if(shift & CAPSLOCK){
80102848:	83 e2 08             	and    $0x8,%edx
  c = charcode[shift & (CTL | SHIFT)][data];
8010284b:	8b 04 85 00 76 10 80 	mov    -0x7fef8a00(,%eax,4),%eax
...
80102873:	31 c0                	xor    %eax,%eax
    shift |= E0ESC;
80102875:	89 1d 7c 16 11 80    	mov    %ebx,0x8011167c
}
...
80102885:	0f 44 c8             	cmove  %eax,%ecx
    shift &= ~(shiftcode[data] | E0ESC);
80102888:	0f b6 81 20 77 10 80 	movzbl -0x7fef88e0(%ecx),%eax
...
80102899:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    shift &= ~(shiftcode[data] | E0ESC);
8010289c:	a3 7c 16 11 80       	mov    %eax,0x8011167c
    return 0;
...
801028db:	e8 a0 df ff ff       	call   80100880 <consoleintr>
}
...
80102bf7:	e8 e4 1b 00 00       	call   801047e0 <memcmp>
...
80102d24:	e8 07 1b 00 00       	call   80104830 <memmove>
...
80102dca:	68 20 78 10 80       	push   $0x80107820
80102dcf:	68 a0 16 11 80       	push   $0x801116a0
80102dd4:	e8 27 17 00 00       	call   80104500 <initlock>
  readsb(dev, &sb);
80102dd9:	58                   	pop    %eax
...
80102de0:	e8 3b e7 ff ff       	call   80101520 <readsb>
...
80102e55:	c9                   	leave  
80102e56:	c3                   	ret    
80102e57:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
80102e6b:	e8 60 18 00 00       	call   801046d0 <acquire>
...
80102e85:	e8 e6 12 00 00       	call   80104170 <sleep>
...
80102ebc:	e8 af 17 00 00       	call   80104670 <release>
      break;
    }
  }
}
...
80102ede:	e8 ed 17 00 00       	call   801046d0 <acquire>
  log.outstanding -= 1;
...
80102f1c:	e8 4f 17 00 00       	call   80104670 <release>
}
...
80102f36:	e8 95 17 00 00       	call   801046d0 <acquire>
    wakeup(&log);
80102f3b:	c7 04 24 a0 16 11 80 	movl   $0x801116a0,(%esp)
    log.committing = 0;
80102f42:	c7 05 e0 16 11 80 00 	movl   $0x0,0x801116e0
80102f49:	00 00 00 
    wakeup(&log);
80102f4c:	e8 df 12 00 00       	call   80104230 <wakeup>
    release(&log.lock);
80102f51:	c7 04 24 a0 16 11 80 	movl   $0x801116a0,(%esp)
80102f58:	e8 13 17 00 00       	call   80104670 <release>
...
80102fb4:	e8 77 18 00 00       	call   80104830 <memmove>
...
80103008:	e8 23 12 00 00       	call   80104230 <wakeup>
  release(&log.lock);
8010300d:	c7 04 24 a0 16 11 80 	movl   $0x801116a0,(%esp)
80103014:	e8 57 16 00 00       	call   80104670 <release>
...
80103027:	68 24 78 10 80       	push   $0x80107824
...
80103053:	0f 8f 85 00 00 00    	jg     801030de <log_write+0x9e>
80103059:	a1 d8 16 11 80       	mov    0x801116d8,%eax
8010305e:	83 e8 01             	sub    $0x1,%eax
80103061:	39 c2                	cmp    %eax,%edx
80103063:	7d 79                	jge    801030de <log_write+0x9e>
    panic("too big a transaction");
  if (log.outstanding < 1)
80103065:	a1 dc 16 11 80       	mov    0x801116dc,%eax
8010306a:	85 c0                	test   %eax,%eax
8010306c:	7e 7d                	jle    801030eb <log_write+0xab>
    panic("log_write outside of trans");

  acquire(&log.lock);
8010306e:	83 ec 0c             	sub    $0xc,%esp
80103071:	68 a0 16 11 80       	push   $0x801116a0
80103076:	e8 55 16 00 00       	call   801046d0 <acquire>
  for (i = 0; i < log.lh.n; i++) {
8010307b:	8b 15 e8 16 11 80    	mov    0x801116e8,%edx
80103081:	83 c4 10             	add    $0x10,%esp
80103084:	85 d2                	test   %edx,%edx
80103086:	7e 4a                	jle    801030d2 <log_write+0x92>
    if (log.lh.block[i] == b->blockno)   // log absorbtion
80103088:	8b 4b 08             	mov    0x8(%ebx),%ecx
  for (i = 0; i < log.lh.n; i++) {
8010308b:	31 c0                	xor    %eax,%eax
8010308d:	eb 08                	jmp    80103097 <log_write+0x57>
8010308f:	90                   	nop
...
801030a7:	83 0b 04             	orl    $0x4,(%ebx)
  release(&log.lock);
}
801030aa:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  release(&log.lock);
801030ad:	c7 45 08 a0 16 11 80 	movl   $0x801116a0,0x8(%ebp)
}
801030b4:	c9                   	leave  
  release(&log.lock);
801030b5:	e9 b6 15 00 00       	jmp    80104670 <release>
...
801030d0:	eb d5                	jmp    801030a7 <log_write+0x67>
  log.lh.block[i] = b->blockno;
801030d2:	8b 43 08             	mov    0x8(%ebx),%eax
801030d5:	a3 ec 16 11 80       	mov    %eax,0x801116ec
  if (i == log.lh.n)
801030da:	75 cb                	jne    801030a7 <log_write+0x67>
801030dc:	eb e9                	jmp    801030c7 <log_write+0x87>
    panic("too big a transaction");
801030de:	83 ec 0c             	sub    $0xc,%esp
801030e1:	68 33 78 10 80       	push   $0x80107833
801030e6:	e8 95 d2 ff ff       	call   80100380 <panic>
    panic("log_write outside of trans");
801030eb:	83 ec 0c             	sub    $0xc,%esp
801030ee:	68 49 78 10 80       	push   $0x80107849
801030f3:	e8 88 d2 ff ff       	call   80100380 <panic>
...
80103107:	e8 44 09 00 00       	call   80103a50 <cpuid>
8010310c:	89 c3                	mov    %eax,%ebx
8010310e:	e8 3d 09 00 00       	call   80103a50 <cpuid>
80103113:	83 ec 04             	sub    $0x4,%esp
80103116:	53                   	push   %ebx
80103117:	50                   	push   %eax
80103118:	68 64 78 10 80       	push   $0x80107864
8010311d:	e8 7e d5 ff ff       	call   801006a0 <cprintf>
  idtinit();       // load idt register
80103122:	e8 a9 29 00 00       	call   80105ad0 <idtinit>
  xchg(&(mycpu()->started), 1); // tell startothers() we're up
80103127:	e8 c4 08 00 00       	call   801039f0 <mycpu>
...
8010312e:	b8 01 00 00 00       	mov    $0x1,%eax
80103133:	f0 87 82 a0 00 00 00 	lock xchg %eax,0xa0(%edx)
  scheduler();     // start running processes
8010313a:	e8 21 0c 00 00       	call   80103d60 <scheduler>
8010313f:	90                   	nop
...
80103143:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80103146:	e8 55 3a 00 00       	call   80106ba0 <switchkvm>
  seginit();
8010314b:	e8 c0 39 00 00       	call   80106b10 <seginit>
  lapicinit();
80103150:	e8 9b f7 ff ff       	call   801028f0 <lapicinit>
  mpmain();
80103155:	e8 a6 ff ff ff       	call   80103100 <mpmain>
...
80103160 <main>:
{
80103160:	8d 4c 24 04          	lea    0x4(%esp),%ecx
80103164:	83 e4 f0             	and    $0xfffffff0,%esp
80103167:	ff 71 fc             	push   -0x4(%ecx)
8010316a:	55                   	push   %ebp
8010316b:	89 e5                	mov    %esp,%ebp
8010316d:	53                   	push   %ebx
8010316e:	51                   	push   %ecx
  kinit1(end, P2V(4*1024*1024)); // phys page allocator
8010316f:	83 ec 08             	sub    $0x8,%esp
80103172:	68 00 00 40 80       	push   $0x80400000
80103177:	68 d0 55 11 80       	push   $0x801155d0
8010317c:	e8 8f f5 ff ff       	call   80102710 <kinit1>
  kvmalloc();      // kernel page table
80103181:	e8 0a 3f 00 00       	call   80107090 <kvmalloc>
  mpinit();        // detect other processors
80103186:	e8 85 01 00 00       	call   80103310 <mpinit>
  lapicinit();     // interrupt controller
8010318b:	e8 60 f7 ff ff       	call   801028f0 <lapicinit>
  seginit();       // segment descriptors
80103190:	e8 7b 39 00 00       	call   80106b10 <seginit>
  picinit();       // disable pic
80103195:	e8 76 03 00 00       	call   80103510 <picinit>
  ioapicinit();    // another interrupt controller
8010319a:	e8 31 f3 ff ff       	call   801024d0 <ioapicinit>
  consoleinit();   // console hardware
8010319f:	e8 bc d8 ff ff       	call   80100a60 <consoleinit>
  uartinit();      // serial port
801031a4:	e8 f7 2b 00 00       	call   80105da0 <uartinit>
  pinit();         // process table
801031a9:	e8 22 08 00 00       	call   801039d0 <pinit>
  tvinit();        // trap vectors
801031ae:	e8 9d 28 00 00       	call   80105a50 <tvinit>
  binit();         // buffer cache
801031b3:	e8 88 ce ff ff       	call   80100040 <binit>
  fileinit();      // file table
801031b8:	e8 53 dc ff ff       	call   80100e10 <fileinit>
  ideinit();       // disk 
801031bd:	e8 fe f0 ff ff       	call   801022c0 <ideinit>
...
801031c5:	68 8a 00 00 00       	push   $0x8a
801031ca:	68 8c a4 10 80       	push   $0x8010a48c
801031cf:	68 00 70 00 80       	push   $0x80007000
801031d4:	e8 57 16 00 00       	call   80104830 <memmove>

  for(c = cpus; c < cpus+ncpu; c++){
801031d9:	83 c4 10             	add    $0x10,%esp
801031dc:	69 05 84 17 11 80 b0 	imul   $0xb0,0x80111784,%eax
801031e3:	00 00 00 
801031e6:	05 a0 17 11 80       	add    $0x801117a0,%eax
801031eb:	3d a0 17 11 80       	cmp    $0x801117a0,%eax
801031f0:	76 7e                	jbe    80103270 <main+0x110>
801031f2:	bb a0 17 11 80       	mov    $0x801117a0,%ebx
801031f7:	eb 20                	jmp    80103219 <main+0xb9>
801031f9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80103200:	69 05 84 17 11 80 b0 	imul   $0xb0,0x80111784,%eax
80103207:	00 00 00 
8010320a:	81 c3 b0 00 00 00    	add    $0xb0,%ebx
80103210:	05 a0 17 11 80       	add    $0x801117a0,%eax
80103215:	39 c3                	cmp    %eax,%ebx
80103217:	73 57                	jae    80103270 <main+0x110>
    if(c == mycpu())  // We've started already.
80103219:	e8 d2 07 00 00       	call   801039f0 <mycpu>
8010321e:	39 c3                	cmp    %eax,%ebx
80103220:	74 de                	je     80103200 <main+0xa0>
      continue;
    ...
    stack = kalloc();
80103222:	e8 59 f5 ff ff       	call   80102780 <kalloc>
...
80103227:	83 ec 08             	sub    $0x8,%esp
    *(void(**)(void))(code-8) = mpenter;
8010322a:	c7 05 f8 6f 00 80 40 	movl   $0x80103140,0x80006ff8
80103231:	31 10 80 
    *(int**)(code-12) = (void *) V2P(entrypgdir);
80103234:	c7 05 f4 6f 00 80 00 	movl   $0x109000,0x80006ff4
8010323b:	90 10 00 
    *(void**)(code-4) = stack + KSTACKSIZE;
8010323e:	05 00 10 00 00       	add    $0x1000,%eax
80103243:	a3 fc 6f 00 80       	mov    %eax,0x80006ffc
    lapicstartap(c->apicid, V2P(code));
80103248:	0f b6 03             	movzbl (%ebx),%eax
8010324b:	68 00 70 00 00       	push   $0x7000
80103250:	50                   	push   %eax
80103251:	e8 ea f7 ff ff       	call   80102a40 <lapicstartap>
...
80103268:	74 f6                	je     80103260 <main+0x100>
8010326a:	eb 94                	jmp    80103200 <main+0xa0>
8010326c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  kinit2(P2V(4*1024*1024), P2V(PHYSTOP)); // must come after startothers()
80103270:	83 ec 08             	sub    $0x8,%esp
80103273:	68 00 00 00 8e       	push   $0x8e000000
80103278:	68 00 00 40 80       	push   $0x80400000
8010327d:	e8 2e f4 ff ff       	call   801026b0 <kinit2>
  userinit();      // first user process
80103282:	e8 19 08 00 00       	call   80103aa0 <userinit>
  mpmain();        // finish this processor's setup
80103287:	e8 74 fe ff ff       	call   80103100 <mpmain>
...
80103294:	56                   	push   %esi
  ...
  addr = P2V(a);
80103295:	8d b0 00 00 00 80    	lea    -0x80000000(%eax),%esi
{
8010329b:	53                   	push   %ebx
  e = addr+len;
8010329c:	8d 1c 16             	lea    (%esi,%edx,1),%ebx
{
8010329f:	83 ec 0c             	sub    $0xc,%esp
  for(p = addr; p < e; p += sizeof(struct mp))
801032a2:	39 de                	cmp    %ebx,%esi
801032a4:	72 10                	jb     801032b6 <mpsearch1+0x26>
801032a6:	eb 50                	jmp    801032f8 <mpsearch1+0x68>
801032a8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801032af:	90                   	nop
801032b0:	89 fe                	mov    %edi,%esi
801032b2:	39 fb                	cmp    %edi,%ebx
801032b4:	76 42                	jbe    801032f8 <mpsearch1+0x68>
    if(memcmp(p, "_MP_", 4) == 0 && sum(p, sizeof(struct mp)) == 0)
801032b6:	83 ec 04             	sub    $0x4,%esp
801032b9:	8d 7e 10             	lea    0x10(%esi),%edi
801032bc:	6a 04                	push   $0x4
801032be:	68 78 78 10 80       	push   $0x80107878
801032c3:	56                   	push   %esi
801032c4:	e8 17 15 00 00       	call   801047e0 <memcmp>
801032c9:	83 c4 10             	add    $0x10,%esp
801032cc:	85 c0                	test   %eax,%eax
801032ce:	75 e0                	jne    801032b0 <mpsearch1+0x20>
801032d0:	89 f2                	mov    %esi,%edx
801032d2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    sum += addr[i];
801032d8:	0f b6 0a             	movzbl (%edx),%ecx
  for(i=0; i<len; i++)
801032db:	83 c2 01             	add    $0x1,%edx
    sum += addr[i];
801032de:	01 c8                	add    %ecx,%eax
  for(i=0; i<len; i++)
801032e0:	39 fa                	cmp    %edi,%edx
801032e2:	75 f4                	jne    801032d8 <mpsearch1+0x48>
    if(memcmp(p, "_MP_", 4) == 0 && sum(p, sizeof(struct mp)) == 0)
801032e4:	84 c0                	test   %al,%al
801032e6:	75 c8                	jne    801032b0 <mpsearch1+0x20>
      return (struct mp*)p;
  return 0;
}
801032e8:	8d 65 f4             	lea    -0xc(%ebp),%esp
801032eb:	89 f0                	mov    %esi,%eax
801032ed:	5b                   	pop    %ebx
801032ee:	5e                   	pop    %esi
801032ef:	5f                   	pop    %edi
801032f0:	5d                   	pop    %ebp
...
80103302:	5d                   	pop    %ebp
80103303:	c3                   	ret    
80103304:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
8010335a:	0f 84 40 01 00 00    	je     801034a0 <mpinit+0x190>
  if((mp = mpsearch()) == 0 || mp->physaddr == 0)
80103360:	8b 73 04             	mov    0x4(%ebx),%esi
80103363:	85 f6                	test   %esi,%esi
80103365:	0f 84 25 01 00 00    	je     80103490 <mpinit+0x180>
  if(memcmp(conf, "PCMP", 4) != 0)
8010336b:	83 ec 04             	sub    $0x4,%esp
  conf = (struct mpconf*) P2V((uint) mp->physaddr);
8010336e:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
  if(memcmp(conf, "PCMP", 4) != 0)
80103374:	6a 04                	push   $0x4
80103376:	68 7d 78 10 80       	push   $0x8010787d
8010337b:	50                   	push   %eax
  conf = (struct mpconf*) P2V((uint) mp->physaddr);
8010337c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
8010337f:	e8 5c 14 00 00       	call   801047e0 <memcmp>
80103384:	83 c4 10             	add    $0x10,%esp
80103387:	85 c0                	test   %eax,%eax
80103389:	0f 85 01 01 00 00    	jne    80103490 <mpinit+0x180>
  if(conf->version != 1 && conf->version != 4)
8010338f:	0f b6 86 06 00 00 80 	movzbl -0x7ffffffa(%esi),%eax
80103396:	3c 01                	cmp    $0x1,%al
80103398:	74 08                	je     801033a2 <mpinit+0x92>
8010339a:	3c 04                	cmp    $0x4,%al
8010339c:	0f 85 ee 00 00 00    	jne    80103490 <mpinit+0x180>
  if(sum((uchar*)conf, conf->length) != 0)
801033a2:	0f b7 96 04 00 00 80 	movzwl -0x7ffffffc(%esi),%edx
  for(i=0; i<len; i++)
801033a9:	66 85 d2             	test   %dx,%dx
801033ac:	74 22                	je     801033d0 <mpinit+0xc0>
801033ae:	8d 3c 32             	lea    (%edx,%esi,1),%edi
801033b1:	89 f0                	mov    %esi,%eax
  sum = 0;
801033b3:	31 d2                	xor    %edx,%edx
801033b5:	8d 76 00             	lea    0x0(%esi),%esi
    sum += addr[i];
801033b8:	0f b6 88 00 00 00 80 	movzbl -0x80000000(%eax),%ecx
  for(i=0; i<len; i++)
801033bf:	83 c0 01             	add    $0x1,%eax
    sum += addr[i];
801033c2:	01 ca                	add    %ecx,%edx
  for(i=0; i<len; i++)
801033c4:	39 c7                	cmp    %eax,%edi
801033c6:	75 f0                	jne    801033b8 <mpinit+0xa8>
  if(sum((uchar*)conf, conf->length) != 0)
801033c8:	84 d2                	test   %dl,%dl
801033ca:	0f 85 c0 00 00 00    	jne    80103490 <mpinit+0x180>
...
801033d0:	8b 86 24 00 00 80    	mov    -0x7fffffdc(%esi),%eax
801033d6:	a3 80 16 11 80       	mov    %eax,0x80111680
  for(p=(uchar*)(conf+1), e=(uchar*)conf+conf->length; p<e; ){
801033db:	0f b7 96 04 00 00 80 	movzwl -0x7ffffffc(%esi),%edx
801033e2:	8d 86 2c 00 00 80    	lea    -0x7fffffd4(%esi),%eax
  ismp = 1;
801033e8:	be 01 00 00 00       	mov    $0x1,%esi
  for(p=(uchar*)(conf+1), e=(uchar*)conf+conf->length; p<e; ){
801033ed:	03 55 e4             	add    -0x1c(%ebp),%edx
801033f0:	89 5d e4             	mov    %ebx,-0x1c(%ebp)
801033f3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801033f7:	90                   	nop
801033f8:	39 d0                	cmp    %edx,%eax
801033fa:	73 15                	jae    80103411 <mpinit+0x101>
    switch(*p){
801033fc:	0f b6 08             	movzbl (%eax),%ecx
801033ff:	80 f9 02             	cmp    $0x2,%cl
80103402:	74 4c                	je     80103450 <mpinit+0x140>
80103404:	77 3a                	ja     80103440 <mpinit+0x130>
80103406:	84 c9                	test   %cl,%cl
80103408:	74 56                	je     80103460 <mpinit+0x150>
    ...
    case MPLINTR:
      p += 8;
8010340a:	83 c0 08             	add    $0x8,%eax
  for(p=(uchar*)(conf+1), e=(uchar*)conf+conf->length; p<e; ){
8010340d:	39 d0                	cmp    %edx,%eax
8010340f:	72 eb                	jb     801033fc <mpinit+0xec>
    default:
      ismp = 0;
      break;
    }
  ...
  if(!ismp)
80103411:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
80103414:	85 f6                	test   %esi,%esi
80103416:	0f 84 d9 00 00 00    	je     801034f5 <mpinit+0x1e5>
    panic("Didn't find a suitable machine");

  if(mp->imcrp){
8010341c:	80 7b 0c 00          	cmpb   $0x0,0xc(%ebx)
80103420:	74 15                	je     80103437 <mpinit+0x127>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80103422:	b8 70 00 00 00       	mov    $0x70,%eax
80103427:	ba 22 00 00 00       	mov    $0x22,%edx
8010342c:	ee                   	out    %al,(%dx)
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
8010342d:	ba 23 00 00 00       	mov    $0x23,%edx
80103432:	ec                   	in     (%dx),%al
    // Bochs doesn't support IMCR, so this doesn't run on Bochs.
    // But it would on real hardware.
    outb(0x22, 0x70);   // Select IMCR
    outb(0x23, inb(0x23) | 1);  // Mask external interrupts.
80103433:	83 c8 01             	or     $0x1,%eax
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
...
80103446:	76 c2                	jbe    8010340a <mpinit+0xfa>
80103448:	31 f6                	xor    %esi,%esi
8010344a:	eb ac                	jmp    801033f8 <mpinit+0xe8>
...
80103454:	83 c0 08             	add    $0x8,%eax
      ioapicid = ioapic->apicno;
80103457:	88 0d 80 17 11 80    	mov    %cl,0x80111780
      continue;
8010345d:	eb 99                	jmp    801033f8 <mpinit+0xe8>
8010345f:	90                   	nop
      if(ncpu < NCPU) {
80103460:	8b 0d 84 17 11 80    	mov    0x80111784,%ecx
80103466:	83 f9 07             	cmp    $0x7,%ecx
80103469:	7f 19                	jg     80103484 <mpinit+0x174>
        cpus[ncpu].apicid = proc->apicid;  // apicid may differ from ncpu
8010346b:	69 f9 b0 00 00 00    	imul   $0xb0,%ecx,%edi
80103471:	0f b6 58 01          	movzbl 0x1(%eax),%ebx
        ncpu++;
80103475:	83 c1 01             	add    $0x1,%ecx
80103478:	89 0d 84 17 11 80    	mov    %ecx,0x80111784
        cpus[ncpu].apicid = proc->apicid;  // apicid may differ from ncpu
8010347e:	88 9f a0 17 11 80    	mov    %bl,-0x7feee860(%edi)
      p += sizeof(struct mpproc);
80103484:	83 c0 14             	add    $0x14,%eax
      continue;
80103487:	e9 6c ff ff ff       	jmp    801033f8 <mpinit+0xe8>
8010348c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    panic("Expect to run on an SMP");
80103490:	83 ec 0c             	sub    $0xc,%esp
80103493:	68 82 78 10 80       	push   $0x80107882
80103498:	e8 e3 ce ff ff       	call   80100380 <panic>
8010349d:	8d 76 00             	lea    0x0(%esi),%esi
{
801034a0:	bb 00 00 0f 80       	mov    $0x800f0000,%ebx
801034a5:	eb 13                	jmp    801034ba <mpinit+0x1aa>
...
801034b8:	74 d6                	je     80103490 <mpinit+0x180>
    if(memcmp(p, "_MP_", 4) == 0 && sum(p, sizeof(struct mp)) == 0)
801034ba:	83 ec 04             	sub    $0x4,%esp
801034bd:	8d 73 10             	lea    0x10(%ebx),%esi
801034c0:	6a 04                	push   $0x4
801034c2:	68 78 78 10 80       	push   $0x80107878
801034c7:	53                   	push   %ebx
801034c8:	e8 13 13 00 00       	call   801047e0 <memcmp>
801034cd:	83 c4 10             	add    $0x10,%esp
801034d0:	85 c0                	test   %eax,%eax
801034d2:	75 dc                	jne    801034b0 <mpinit+0x1a0>
801034d4:	89 da                	mov    %ebx,%edx
801034d6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
801034ea:	75 f4                	jne    801034e0 <mpinit+0x1d0>
    if(memcmp(p, "_MP_", 4) == 0 && sum(p, sizeof(struct mp)) == 0)
801034ec:	84 c0                	test   %al,%al
801034ee:	75 c0                	jne    801034b0 <mpinit+0x1a0>
801034f0:	e9 6b fe ff ff       	jmp    80103360 <mpinit+0x50>
    panic("Didn't find a suitable machine");
801034f5:	83 ec 0c             	sub    $0xc,%esp
801034f8:	68 9c 78 10 80       	push   $0x8010789c
...
8010353c:	8b 75 0c             	mov    0xc(%ebp),%esi
  ...
  p = 0;
  *f0 = *f1 = 0;
8010353f:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
80103545:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  if((*f0 = filealloc()) == 0 || (*f1 = filealloc()) == 0)
8010354b:	e8 e0 d8 ff ff       	call   80100e30 <filealloc>
80103550:	89 03                	mov    %eax,(%ebx)
80103552:	85 c0                	test   %eax,%eax
80103554:	0f 84 a8 00 00 00    	je     80103602 <pipealloc+0xd2>
8010355a:	e8 d1 d8 ff ff       	call   80100e30 <filealloc>
8010355f:	89 06                	mov    %eax,(%esi)
...
801035a0:	00 00 00 
  initlock(&p->lock, "pipe");
801035a3:	68 bb 78 10 80       	push   $0x801078bb
801035a8:	50                   	push   %eax
801035a9:	e8 52 0f 00 00       	call   80104500 <initlock>
  (*f0)->type = FD_PIPE;
...
801035b3:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
  (*f0)->readable = 1;
801035b9:	8b 03                	mov    (%ebx),%eax
801035bb:	c6 40 08 01          	movb   $0x1,0x8(%eax)
  (*f0)->writable = 0;
801035bf:	8b 03                	mov    (%ebx),%eax
801035c1:	c6 40 09 00          	movb   $0x0,0x9(%eax)
  (*f0)->pipe = p;
801035c5:	8b 03                	mov    (%ebx),%eax
...
8010360c:	e8 df d8 ff ff       	call   80100ef0 <fileclose>
...
8010363f:	e8 8c 10 00 00       	call   801046d0 <acquire>
  if(writable){
80103644:	83 c4 10             	add    $0x10,%esp
80103647:	85 f6                	test   %esi,%esi
80103649:	74 65                	je     801036b0 <pipeclose+0x80>
    p->writeopen = 0;
    wakeup(&p->nread);
8010364b:	83 ec 0c             	sub    $0xc,%esp
8010364e:	8d 83 34 02 00 00    	lea    0x234(%ebx),%eax
    p->writeopen = 0;
80103654:	c7 83 40 02 00 00 00 	movl   $0x0,0x240(%ebx)
8010365b:	00 00 00 
    wakeup(&p->nread);
8010365e:	50                   	push   %eax
8010365f:	e8 cc 0b 00 00       	call   80104230 <wakeup>
...
80103679:	74 15                	je     80103690 <pipeclose+0x60>
    release(&p->lock);
    kfree((char*)p);
  } else
    release(&p->lock);
...
80103683:	5d                   	pop    %ebp
    release(&p->lock);
80103684:	e9 e7 0f 00 00       	jmp    80104670 <release>
80103689:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    release(&p->lock);
80103690:	83 ec 0c             	sub    $0xc,%esp
80103693:	53                   	push   %ebx
80103694:	e8 d7 0f 00 00       	call   80104670 <release>
    kfree((char*)p);
...
801036a4:	5d                   	pop    %ebp
    kfree((char*)p);
801036a5:	e9 16 ef ff ff       	jmp    801025c0 <kfree>
801036aa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    wakeup(&p->nwrite);
801036b0:	83 ec 0c             	sub    $0xc,%esp
801036b3:	8d 83 38 02 00 00    	lea    0x238(%ebx),%eax
    p->readopen = 0;
801036b9:	c7 83 3c 02 00 00 00 	movl   $0x0,0x23c(%ebx)
801036c0:	00 00 00 
    wakeup(&p->nwrite);
801036c3:	50                   	push   %eax
801036c4:	e8 67 0b 00 00       	call   80104230 <wakeup>
801036c9:	83 c4 10             	add    $0x10,%esp
801036cc:	eb 99                	jmp    80103667 <pipeclose+0x37>
...
801036dd:	e8 ee 0f 00 00       	call   801046d0 <acquire>
  for(i = 0; i < n; i++){
801036e2:	8b 45 10             	mov    0x10(%ebp),%eax
801036e5:	83 c4 10             	add    $0x10,%esp
801036e8:	85 c0                	test   %eax,%eax
801036ea:	0f 8e c0 00 00 00    	jle    801037b0 <pipewrite+0xe0>
801036f0:	8b 45 0c             	mov    0xc(%ebp),%eax
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
801036f3:	8b 8b 38 02 00 00    	mov    0x238(%ebx),%ecx
...
801036ff:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80103702:	03 45 10             	add    0x10(%ebp),%eax
80103705:	89 45 e0             	mov    %eax,-0x20(%ebp)
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
80103708:	8b 83 34 02 00 00    	mov    0x234(%ebx),%eax
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
8010370e:	8d b3 38 02 00 00    	lea    0x238(%ebx),%esi
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
80103714:	89 ca                	mov    %ecx,%edx
80103716:	05 00 02 00 00       	add    $0x200,%eax
8010371b:	39 c1                	cmp    %eax,%ecx
8010371d:	74 3f                	je     8010375e <pipewrite+0x8e>
8010371f:	eb 67                	jmp    80103788 <pipewrite+0xb8>
80103721:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      if(p->readopen == 0 || myproc()->killed){
80103728:	e8 43 03 00 00       	call   80103a70 <myproc>
8010372d:	8b 48 28             	mov    0x28(%eax),%ecx
80103730:	85 c9                	test   %ecx,%ecx
80103732:	75 34                	jne    80103768 <pipewrite+0x98>
      wakeup(&p->nread);
80103734:	83 ec 0c             	sub    $0xc,%esp
80103737:	57                   	push   %edi
80103738:	e8 f3 0a 00 00       	call   80104230 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
8010373d:	58                   	pop    %eax
8010373e:	5a                   	pop    %edx
8010373f:	53                   	push   %ebx
80103740:	56                   	push   %esi
80103741:	e8 2a 0a 00 00       	call   80104170 <sleep>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
80103746:	8b 83 34 02 00 00    	mov    0x234(%ebx),%eax
8010374c:	8b 93 38 02 00 00    	mov    0x238(%ebx),%edx
80103752:	83 c4 10             	add    $0x10,%esp
80103755:	05 00 02 00 00       	add    $0x200,%eax
8010375a:	39 c2                	cmp    %eax,%edx
8010375c:	75 2a                	jne    80103788 <pipewrite+0xb8>
      if(p->readopen == 0 || myproc()->killed){
8010375e:	8b 83 3c 02 00 00    	mov    0x23c(%ebx),%eax
80103764:	85 c0                	test   %eax,%eax
80103766:	75 c0                	jne    80103728 <pipewrite+0x58>
        release(&p->lock);
80103768:	83 ec 0c             	sub    $0xc,%esp
8010376b:	53                   	push   %ebx
8010376c:	e8 ff 0e 00 00       	call   80104670 <release>
        return -1;
...
80103781:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    p->data[p->nwrite++ % PIPESIZE] = addr[i];
80103788:	8b 75 e4             	mov    -0x1c(%ebp),%esi
8010378b:	8d 4a 01             	lea    0x1(%edx),%ecx
8010378e:	81 e2 ff 01 00 00    	and    $0x1ff,%edx
80103794:	89 8b 38 02 00 00    	mov    %ecx,0x238(%ebx)
8010379a:	0f b6 06             	movzbl (%esi),%eax
  for(i = 0; i < n; i++){
8010379d:	83 c6 01             	add    $0x1,%esi
801037a0:	89 75 e4             	mov    %esi,-0x1c(%ebp)
    p->data[p->nwrite++ % PIPESIZE] = addr[i];
801037a3:	88 44 13 34          	mov    %al,0x34(%ebx,%edx,1)
  for(i = 0; i < n; i++){
801037a7:	3b 75 e0             	cmp    -0x20(%ebp),%esi
801037aa:	0f 85 58 ff ff ff    	jne    80103708 <pipewrite+0x38>
  wakeup(&p->nread);  //DOC: pipewrite-wakeup1
801037b0:	83 ec 0c             	sub    $0xc,%esp
801037b3:	8d 83 34 02 00 00    	lea    0x234(%ebx),%eax
801037b9:	50                   	push   %eax
801037ba:	e8 71 0a 00 00       	call   80104230 <wakeup>
  release(&p->lock);
801037bf:	89 1c 24             	mov    %ebx,(%esp)
801037c2:	e8 a9 0e 00 00       	call   80104670 <release>
  return n;
801037c7:	8b 45 10             	mov    0x10(%ebp),%eax
801037ca:	83 c4 10             	add    $0x10,%esp
801037cd:	eb aa                	jmp    80103779 <pipewrite+0xa9>
801037cf:	90                   	nop
...
801037d9:	8b 75 08             	mov    0x8(%ebp),%esi
801037dc:	8b 7d 0c             	mov    0xc(%ebp),%edi
  int i;

  acquire(&p->lock);
801037df:	56                   	push   %esi
801037e0:	8d 9e 34 02 00 00    	lea    0x234(%esi),%ebx
801037e6:	e8 e5 0e 00 00       	call   801046d0 <acquire>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
801037eb:	8b 86 34 02 00 00    	mov    0x234(%esi),%eax
801037f1:	83 c4 10             	add    $0x10,%esp
801037f4:	39 86 38 02 00 00    	cmp    %eax,0x238(%esi)
801037fa:	74 2f                	je     8010382b <piperead+0x5b>
801037fc:	eb 37                	jmp    80103835 <piperead+0x65>
801037fe:	66 90                	xchg   %ax,%ax
    if(myproc()->killed){
80103800:	e8 6b 02 00 00       	call   80103a70 <myproc>
80103805:	8b 48 28             	mov    0x28(%eax),%ecx
80103808:	85 c9                	test   %ecx,%ecx
8010380a:	0f 85 80 00 00 00    	jne    80103890 <piperead+0xc0>
      release(&p->lock);
      return -1;
    }
...
80103815:	e8 56 09 00 00       	call   80104170 <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
8010381a:	8b 86 38 02 00 00    	mov    0x238(%esi),%eax
80103820:	83 c4 10             	add    $0x10,%esp
80103823:	39 86 34 02 00 00    	cmp    %eax,0x234(%esi)
80103829:	75 0a                	jne    80103835 <piperead+0x65>
8010382b:	8b 86 40 02 00 00    	mov    0x240(%esi),%eax
80103831:	85 c0                	test   %eax,%eax
80103833:	75 cb                	jne    80103800 <piperead+0x30>
  }
  for(i = 0; i < n; i++){  //DOC: piperead-copy
80103835:	8b 55 10             	mov    0x10(%ebp),%edx
80103838:	31 db                	xor    %ebx,%ebx
8010383a:	85 d2                	test   %edx,%edx
8010383c:	7f 20                	jg     8010385e <piperead+0x8e>
8010383e:	eb 2c                	jmp    8010386c <piperead+0x9c>
    if(p->nread == p->nwrite)
      break;
...
80103899:	e8 d2 0d 00 00       	call   80104670 <release>
      return -1;
...
801038b4:	bb 54 1d 11 80       	mov    $0x80111d54,%ebx
{
801038b9:	83 ec 10             	sub    $0x10,%esp
  acquire(&ptable.lock);
801038bc:	68 20 1d 11 80       	push   $0x80111d20
801038c1:	e8 0a 0e 00 00       	call   801046d0 <acquire>
801038c6:	83 c4 10             	add    $0x10,%esp
801038c9:	eb 10                	jmp    801038db <allocproc+0x2b>
801038cb:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801038cf:	90                   	nop
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801038d0:	83 eb 80             	sub    $0xffffff80,%ebx
801038d3:	81 fb 54 3d 11 80    	cmp    $0x80113d54,%ebx
801038d9:	74 75                	je     80103950 <allocproc+0xa0>
    if(p->state == UNUSED)
...
801038ea:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
  p->pid = nextpid++;
801038f1:	89 43 10             	mov    %eax,0x10(%ebx)
801038f4:	8d 50 01             	lea    0x1(%eax),%edx
  release(&ptable.lock);
801038f7:	68 20 1d 11 80       	push   $0x80111d20
  p->pid = nextpid++;
801038fc:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103902:	e8 69 0d 00 00       	call   80104670 <release>

  // Allocate kernel stack.
  if((p->kstack = kalloc()) == 0){
80103907:	e8 74 ee ff ff       	call   80102780 <kalloc>
...
8010391f:	05 9c 0f 00 00       	add    $0xf9c,%eax
  sp -= sizeof *p->tf;
80103924:	89 53 1c             	mov    %edx,0x1c(%ebx)
  *(uint*)sp = (uint)trapret;
80103927:	c7 40 14 42 5a 10 80 	movl   $0x80105a42,0x14(%eax)
  p->context = (struct context*)sp;
8010392e:	89 43 20             	mov    %eax,0x20(%ebx)
  memset(p->context, 0, sizeof *p->context);
...
8010393b:	8b 43 20             	mov    0x20(%ebx),%eax
...
80103953:	31 db                	xor    %ebx,%ebx
  release(&ptable.lock);
80103955:	68 20 1d 11 80       	push   $0x80111d20
8010395a:	e8 11 0d 00 00       	call   80104670 <release>
}
...
8010398b:	e8 e0 0c 00 00       	call   80104670 <release>
...
8010399e:	66 90                	xchg   %ax,%ax
    first = 0;
801039a0:	c7 05 00 a0 10 80 00 	movl   $0x0,0x8010a000
801039a7:	00 00 00 
    iinit(ROOTDEV);
801039aa:	83 ec 0c             	sub    $0xc,%esp
801039ad:	6a 01                	push   $0x1
801039af:	e8 ac db ff ff       	call   80101560 <iinit>
    initlog(ROOTDEV);
801039b4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801039bb:	e8 00 f4 ff ff       	call   80102dc0 <initlog>
}
801039c0:	83 c4 10             	add    $0x10,%esp
801039c3:	c9                   	leave  
801039c4:	c3                   	ret    
801039c5:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
801039d6:	68 c0 78 10 80       	push   $0x801078c0
801039db:	68 20 1d 11 80       	push   $0x80111d20
801039e0:	e8 1b 0b 00 00       	call   80104500 <initlock>
}
...
801039fa:	75 46                	jne    80103a42 <mycpu+0x52>
  apicid = lapicid();
801039fc:	e8 ef ef ff ff       	call   801029f0 <lapicid>
  for (i = 0; i < ncpu; ++i) {
80103a01:	8b 35 84 17 11 80    	mov    0x80111784,%esi
...
80103a1d:	0f b6 99 a0 17 11 80 	movzbl -0x7feee860(%ecx),%ebx
80103a24:	39 c3                	cmp    %eax,%ebx
80103a26:	75 e8                	jne    80103a10 <mycpu+0x20>
}
80103a28:	8d 65 f8             	lea    -0x8(%ebp),%esp
      return &cpus[i];
80103a2b:	8d 81 a0 17 11 80    	lea    -0x7feee860(%ecx),%eax
}
80103a31:	5b                   	pop    %ebx
80103a32:	5e                   	pop    %esi
80103a33:	5d                   	pop    %ebp
...
80103a5b:	c9                   	leave  
  return mycpu()-cpus;
80103a5c:	2d a0 17 11 80       	sub    $0x801117a0,%eax
...
80103a74:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103a77:	e8 04 0b 00 00       	call   80104580 <pushcli>
  c = mycpu();
80103a7c:	e8 6f ff ff ff       	call   801039f0 <mycpu>
  p = c->proc;
80103a81:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103a87:	e8 44 0b 00 00       	call   801045d0 <popcli>
}
...
80103aa4:	83 ec 04             	sub    $0x4,%esp
  p = allocproc();
80103aa7:	e8 04 fe ff ff       	call   801038b0 <allocproc>
80103aac:	89 c3                	mov    %eax,%ebx
  initproc = p;
80103aae:	a3 54 3d 11 80       	mov    %eax,0x80113d54
  if((p->pgdir = setupkvm()) == 0)
80103ab3:	e8 58 35 00 00       	call   80107010 <setupkvm>
80103ab8:	89 43 04             	mov    %eax,0x4(%ebx)
80103abb:	85 c0                	test   %eax,%eax
80103abd:	0f 84 dd 00 00 00    	je     80103ba0 <userinit+0x100>
...
80103ad0:	68 f0 78 10 80       	push   $0x801078f0
80103ad5:	e8 c6 cb ff ff       	call   801006a0 <cprintf>
  inituvm(p->pgdir, _binary_initcode_start, (int)_binary_initcode_size);
80103ada:	83 c4 0c             	add    $0xc,%esp
80103add:	68 2c 00 00 00       	push   $0x2c
80103ae2:	68 60 a4 10 80       	push   $0x8010a460
80103ae7:	ff 73 04             	push   0x4(%ebx)
80103aea:	e8 d1 31 00 00       	call   80106cc0 <inituvm>
  memset(p->tf, 0, sizeof(*p->tf));
80103aef:	83 c4 0c             	add    $0xc,%esp
  p->sz = PGSIZE;
80103af2:	c7 03 00 10 00 00    	movl   $0x1000,(%ebx)
  memset(p->tf, 0, sizeof(*p->tf));
80103af8:	6a 4c                	push   $0x4c
80103afa:	6a 00                	push   $0x0
80103afc:	ff 73 1c             	push   0x1c(%ebx)
80103aff:	e8 8c 0c 00 00       	call   80104790 <memset>
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
80103b04:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103b07:	ba 1b 00 00 00       	mov    $0x1b,%edx
  safestrcpy(p->name, "initcode", sizeof(p->name));
80103b0c:	83 c4 0c             	add    $0xc,%esp
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
80103b0f:	b9 23 00 00 00       	mov    $0x23,%ecx
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
80103b14:	66 89 50 3c          	mov    %dx,0x3c(%eax)
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
80103b18:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103b1b:	66 89 48 2c          	mov    %cx,0x2c(%eax)
  p->tf->es = p->tf->ds;
80103b1f:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103b22:	0f b7 50 2c          	movzwl 0x2c(%eax),%edx
80103b26:	66 89 50 28          	mov    %dx,0x28(%eax)
  p->tf->ss = p->tf->ds;
80103b2a:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103b2d:	0f b7 50 2c          	movzwl 0x2c(%eax),%edx
80103b31:	66 89 50 48          	mov    %dx,0x48(%eax)
  p->tf->eflags = FL_IF;
80103b35:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103b38:	c7 40 40 00 02 00 00 	movl   $0x200,0x40(%eax)
  p->tf->esp = PGSIZE;
80103b3f:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103b42:	c7 40 44 00 10 00 00 	movl   $0x1000,0x44(%eax)
  p->tf->eip = 0;  // beginning of initcode.S
80103b49:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103b4c:	c7 40 38 00 00 00 00 	movl   $0x0,0x38(%eax)
  safestrcpy(p->name, "initcode", sizeof(p->name));
80103b53:	8d 43 70             	lea    0x70(%ebx),%eax
80103b56:	6a 10                	push   $0x10
80103b58:	68 f7 78 10 80       	push   $0x801078f7
80103b5d:	50                   	push   %eax
80103b5e:	e8 ed 0d 00 00       	call   80104950 <safestrcpy>
  p->cwd = namei("/");
80103b63:	c7 04 24 00 79 10 80 	movl   $0x80107900,(%esp)
80103b6a:	e8 31 e5 ff ff       	call   801020a0 <namei>
  p->ticks = 0;
80103b6f:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
  p->cwd = namei("/");
80103b76:	89 43 6c             	mov    %eax,0x6c(%ebx)
  acquire(&ptable.lock);
80103b79:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103b80:	e8 4b 0b 00 00       	call   801046d0 <acquire>
  p->state = RUNNABLE;
80103b85:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
80103b8c:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103b93:	e8 d8 0a 00 00       	call   80104670 <release>
}
...
80103ba3:	68 d7 78 10 80       	push   $0x801078d7
...
80103bb5:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103bb8:	e8 c3 09 00 00       	call   80104580 <pushcli>
  c = mycpu();
80103bbd:	e8 2e fe ff ff       	call   801039f0 <mycpu>
  p = c->proc;
80103bc2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103bc8:	e8 03 0a 00 00       	call   801045d0 <popcli>
  sz = curproc->sz;
...
80103bdb:	e8 d0 2f 00 00       	call   80106bb0 <switchuvm>
  return 0;
...
80103bfa:	e8 31 32 00 00       	call   80106e30 <allocuvm>
...
80103c1a:	e8 41 33 00 00       	call   80106f60 <deallocuvm>
...
80103c43:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103c49:	e8 82 09 00 00       	call   801045d0 <popcli>
  if((np = allocproc()) == 0){
80103c4e:	e8 5d fc ff ff       	call   801038b0 <allocproc>
80103c53:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80103c56:	85 c0                	test   %eax,%eax
80103c58:	0f 84 c7 00 00 00    	je     80103d25 <fork+0xf5>
  if((np->pgdir = copyuvm(curproc->pgdir, curproc->sz)) == 0){
80103c5e:	83 ec 08             	sub    $0x8,%esp
80103c61:	ff 33                	push   (%ebx)
80103c63:	89 c7                	mov    %eax,%edi
80103c65:	ff 73 04             	push   0x4(%ebx)
80103c68:	e8 93 34 00 00       	call   80107100 <copyuvm>
80103c6d:	83 c4 10             	add    $0x10,%esp
80103c70:	89 47 04             	mov    %eax,0x4(%edi)
80103c73:	85 c0                	test   %eax,%eax
80103c75:	0f 84 b1 00 00 00    	je     80103d2c <fork+0xfc>
  np->sz = curproc->sz;
80103c7b:	8b 03                	mov    (%ebx),%eax
80103c7d:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80103c80:	89 01                	mov    %eax,(%ecx)
  *np->tf = *curproc->tf;
80103c82:	8b 79 1c             	mov    0x1c(%ecx),%edi
  np->parent = curproc;
80103c85:	89 c8                	mov    %ecx,%eax
80103c87:	89 59 18             	mov    %ebx,0x18(%ecx)
  np->ticks = 0;
80103c8a:	c7 41 14 00 00 00 00 	movl   $0x0,0x14(%ecx)
  *np->tf = *curproc->tf;
80103c91:	b9 13 00 00 00       	mov    $0x13,%ecx
80103c96:	8b 73 1c             	mov    0x1c(%ebx),%esi
80103c99:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  for(i = 0; i < NOFILE; i++)
80103c9b:	31 f6                	xor    %esi,%esi
  np->tf->eax = 0;
80103c9d:	8b 40 1c             	mov    0x1c(%eax),%eax
80103ca0:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
  for(i = 0; i < NOFILE; i++)
80103ca7:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80103cae:	66 90                	xchg   %ax,%ax
    if(curproc->ofile[i])
80103cb0:	8b 44 b3 2c          	mov    0x2c(%ebx,%esi,4),%eax
80103cb4:	85 c0                	test   %eax,%eax
80103cb6:	74 13                	je     80103ccb <fork+0x9b>
...
80103cc7:	89 44 b2 2c          	mov    %eax,0x2c(%edx,%esi,4)
  for(i = 0; i < NOFILE; i++)
80103ccb:	83 c6 01             	add    $0x1,%esi
80103cce:	83 fe 10             	cmp    $0x10,%esi
80103cd1:	75 dd                	jne    80103cb0 <fork+0x80>
  np->cwd = idup(curproc->cwd);
80103cd3:	83 ec 0c             	sub    $0xc,%esp
80103cd6:	ff 73 6c             	push   0x6c(%ebx)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103cd9:	83 c3 70             	add    $0x70,%ebx
  np->cwd = idup(curproc->cwd);
80103cdc:	e8 6f da ff ff       	call   80101750 <idup>
80103ce1:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103ce4:	83 c4 0c             	add    $0xc,%esp
  np->cwd = idup(curproc->cwd);
80103ce7:	89 47 6c             	mov    %eax,0x6c(%edi)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103cea:	8d 47 70             	lea    0x70(%edi),%eax
80103ced:	6a 10                	push   $0x10
80103cef:	53                   	push   %ebx
80103cf0:	50                   	push   %eax
80103cf1:	e8 5a 0c 00 00       	call   80104950 <safestrcpy>
  pid = np->pid;
80103cf6:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103cf9:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103d00:	e8 cb 09 00 00       	call   801046d0 <acquire>
  np->state = RUNNABLE;
80103d05:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103d0c:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103d13:	e8 58 09 00 00       	call   80104670 <release>
  return pid;
...
80103d2a:	eb ef                	jmp    80103d1b <fork+0xeb>
    kfree(np->kstack);
80103d2c:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
80103d2f:	83 ec 0c             	sub    $0xc,%esp
80103d32:	ff 73 08             	push   0x8(%ebx)
...
80103d50:	eb c9                	jmp    80103d1b <fork+0xeb>
...
80103d66:	83 ec 0c             	sub    $0xc,%esp
  struct cpu *c = mycpu();
80103d69:	e8 82 fc ff ff       	call   801039f0 <mycpu>
  c->proc = 0;
...
80103db0:	e8 fb 2d 00 00       	call   80106bb0 <switchuvm>
...
80103dc2:	e8 e4 0b 00 00       	call   801049ab <swtch>
      switchkvm();
80103dc7:	e8 d4 2d 00 00       	call   80106ba0 <switchkvm>
      c->proc = 0;
...
80103e05:	e8 76 07 00 00       	call   80104580 <pushcli>
  c = mycpu();
80103e0a:	e8 e1 fb ff ff       	call   801039f0 <mycpu>
  p = c->proc;
...
80103e2c:	74 4f                	je     80103e7d <sched+0x7d>
  if(mycpu()->ncli != 1)
80103e2e:	e8 bd fb ff ff       	call   801039f0 <mycpu>
...
80103e47:	75 41                	jne    80103e8a <sched+0x8a>
  intena = mycpu()->intena;
80103e49:	e8 a2 fb ff ff       	call   801039f0 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103e4e:	83 c3 20             	add    $0x20,%ebx
  intena = mycpu()->intena;
80103e51:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103e57:	e8 94 fb ff ff       	call   801039f0 <mycpu>
...
80103e63:	e8 43 0b 00 00       	call   801049ab <swtch>
  mycpu()->intena = intena;
80103e68:	e8 83 fb ff ff       	call   801039f0 <mycpu>
}
...
80103ec6:	83 ec 0c             	sub    $0xc,%esp
  struct proc *curproc = myproc();
80103ec9:	e8 a2 fb ff ff       	call   80103a70 <myproc>
  if(curproc == initproc)
...
80103fcd:	68 4f 79 10 80       	push   $0x8010794f
80103fd2:	e8 a9 c3 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103fd7:	83 ec 0c             	sub    $0xc,%esp
80103fda:	68 42 79 10 80       	push   $0x80107942
...
80103ff5:	e8 86 05 00 00       	call   80104580 <pushcli>
  c = mycpu();
80103ffa:	e8 f1 f9 ff ff       	call   801039f0 <mycpu>
  p = c->proc;
...
80104056:	8b 46 28             	mov    0x28(%esi),%eax
...
80104061:	e8 1a 05 00 00       	call   80104580 <pushcli>
  c = mycpu();
80104066:	e8 85 f9 ff ff       	call   801039f0 <mycpu>
  p = c->proc;
...
801040a9:	e8 12 e5 ff ff       	call   801025c0 <kfree>
        p->kstack = 0;
801040ae:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
801040b5:	5a                   	pop    %edx
801040b6:	ff 73 04             	push   0x4(%ebx)
801040b9:	e8 d2 2e 00 00       	call   80106f90 <freevm>
        p->pid = 0;
801040be:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
801040c5:	c7 43 18 00 00 00 00 	movl   $0x0,0x18(%ebx)
        p->name[0] = 0;
801040cc:	c6 43 70 00          	movb   $0x0,0x70(%ebx)
        p->killed = 0;
801040d0:	c7 43 28 00 00 00 00 	movl   $0x0,0x28(%ebx)
        p->state = UNUSED;
...
80104110:	68 5b 79 10 80       	push   $0x8010795b
...
80104131:	e8 4a 04 00 00       	call   80104580 <pushcli>
  c = mycpu();
80104136:	e8 b5 f8 ff ff       	call   801039f0 <mycpu>
  p = c->proc;
...
801041f1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  p->chan = chan;
801041f8:	89 7b 24             	mov    %edi,0x24(%ebx)
  p->state = SLEEPING;
...
80104219:	68 61 79 10 80       	push   $0x80107961
8010421e:	e8 5d c1 ff ff       	call   80100380 <panic>
    panic("sleep");
80104223:	83 ec 0c             	sub    $0xc,%esp
80104226:	68 5b 79 10 80       	push   $0x8010795b
...
80104260:	3b 58 24             	cmp    0x24(%eax),%ebx
...
801042bf:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
      p->killed = 1;
801042c3:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
      if(p->state == SLEEPING)
...
80104319:	bb c4 1d 11 80       	mov    $0x80111dc4,%ebx
...
801043ad:	68 a1 73 10 80       	push   $0x801073a1
...
801043da:	68 ec 79 10 80       	push   $0x801079ec
...
80104443:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104449:	e8 22 f6 ff ff       	call   80103a70 <myproc>
...
801044eb:	e8 80 f5 ff ff       	call   80103a70 <myproc>
...
801045aa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    mycpu()->intena = eflags & FL_IF;
801045b0:	e8 3b f4 ff ff       	call   801039f0 <mycpu>
...
801045fc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104600:	e8 eb f3 ff ff       	call   801039f0 <mycpu>
...
80104615:	68 f7 79 10 80       	push   $0x801079f7
8010461a:	e8 61 bd ff ff       	call   80100380 <panic>
    panic("popcli");
8010461f:	83 ec 0c             	sub    $0xc,%esp
80104622:	68 0e 7a 10 80       	push   $0x80107a0e
...
80104653:	e8 98 f3 ff ff       	call   801039f0 <mycpu>
...
8010470c:	e8 df f2 ff ff       	call   801039f0 <mycpu>
...
8010476b:	e8 80 f2 ff ff       	call   801039f0 <mycpu>
...
80104780:	68 1d 7a 10 80       	push   $0x80107a1d
...
801049c7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
801049ca:	e8 a1 f0 ff ff       	call   80103a70 <myproc>
...
80104a07:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80104a0a:	e8 61 f0 ff ff       	call   80103a70 <myproc>
...
80104a55:	e8 16 f0 ff ff       	call   80103a70 <myproc>
...
80104a63:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104a66:	e8 05 f0 ff ff       	call   80103a70 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104aa6:	83 ec 0c             	sub    $0xc,%esp
  int i;
  struct proc *curproc = myproc();
80104aa9:	e8 c2 ef ff ff       	call   80103a70 <myproc>
80104aae:	89 c6                	mov    %eax,%esi
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104ab0:	e8 bb ef ff ff       	call   80103a70 <myproc>
...
80104abe:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104ac1:	e8 aa ef ff ff       	call   80103a70 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104b14:	53                   	push   %ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104b15:	e8 56 ef ff ff       	call   80103a70 <myproc>
80104b1a:	8b 55 08             	mov    0x8(%ebp),%edx
80104b1d:	8b 40 1c             	mov    0x1c(%eax),%eax
80104b20:	8b 40 44             	mov    0x44(%eax),%eax
80104b23:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104b26:	e8 45 ef ff ff       	call   80103a70 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104b3b:	8b 5b 04             	mov    0x4(%ebx),%ebx
  struct proc *curproc = myproc();
80104b3e:	e8 2d ef ff ff       	call   80103a70 <myproc>
  if(addr >= curproc->sz)
...
80104b94:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104b97:	e8 d4 ee ff ff       	call   80103a70 <myproc>
...
80104bd0:	50                   	push   %eax
            curproc->pid, curproc->name, num);
80104bd1:	8d 43 70             	lea    0x70(%ebx),%eax
    cprintf("%d %s: unknown sys call %d\n",
80104bd4:	50                   	push   %eax
80104bd5:	ff 73 10             	push   0x10(%ebx)
80104bd8:	68 25 7a 10 80       	push   $0x80107a25
80104bdd:	e8 be ba ff ff       	call   801006a0 <cprintf>
    curproc->tf->eax = -1;
80104be2:	8b 43 1c             	mov    0x1c(%ebx),%eax
...
80104d34:	68 dc 7a 10 80       	push   $0x80107adc
...
80104d4c:	68 db 7a 10 80       	push   $0x80107adb
...
80104d61:	68 cf 7a 10 80       	push   $0x80107acf
...
80104d7f:	68 de 7a 10 80       	push   $0x80107ade
80104d84:	e8 f7 b5 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104d89:	83 ec 0c             	sub    $0xc,%esp
80104d8c:	68 c0 7a 10 80       	push   $0x80107ac0
...
80104dc0:	e8 ab ec ff ff       	call   80103a70 <myproc>
...
80104dce:	74 20                	je     80104df0 <sys_dup+0x50>
  struct proc *curproc = myproc();
80104dd0:	e8 9b ec ff ff       	call   80103a70 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80104e00:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
80104e03:	89 74 98 2c          	mov    %esi,0x2c(%eax,%ebx,4)
  filedup(f);
...
80104e40:	e8 2b ec ff ff       	call   80103a70 <myproc>
80104e45:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104e48:	8b 74 90 2c          	mov    0x2c(%eax,%edx,4),%esi
...
80104ec0:	e8 ab eb ff ff       	call   80103a70 <myproc>
...
80104f40:	e8 2b eb ff ff       	call   80103a70 <myproc>
80104f45:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104f48:	8d 5a 08             	lea    0x8(%edx),%ebx
80104f4b:	8b 74 98 0c          	mov    0xc(%eax,%ebx,4),%esi
80104f4f:	85 f6                	test   %esi,%esi
80104f51:	74 25                	je     80104f78 <sys_close+0x58>
  myproc()->ofile[fd] = 0;
80104f53:	e8 18 eb ff ff       	call   80103a70 <myproc>
  fileclose(f);
80104f58:	83 ec 0c             	sub    $0xc,%esp
  myproc()->ofile[fd] = 0;
80104f5b:	c7 44 98 0c 00 00 00 	movl   $0x0,0xc(%eax,%ebx,4)
80104f62:	00 
  fileclose(f);
...
80104fa0:	e8 cb ea ff ff       	call   80103a70 <myproc>
...
80105127:	eb a1                	jmp    801050ca <sys_link+0xda>
    end_op();
80105129:	e8 a2 dd ff ff       	call   80102ed0 <end_op>
    return -1;
...
80105159:	0f 88 7a 01 00 00    	js     801052d9 <sys_unlink+0x199>
  begin_op();
8010515f:	e8 fc dc ff ff       	call   80102e60 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
...
80105247:	e8 c4 c7 ff ff       	call   80101a10 <iunlockput>
  end_op();
8010524c:	e8 7f dc ff ff       	call   80102ed0 <end_op>
  return 0;
...
801052a6:	e8 65 c7 ff ff       	call   80101a10 <iunlockput>
  end_op();
801052ab:	e8 20 dc ff ff       	call   80102ed0 <end_op>
  return -1;
...
801052de:	e9 73 ff ff ff       	jmp    80105256 <sys_unlink+0x116>
    end_op();
801052e3:	e8 e8 db ff ff       	call   80102ed0 <end_op>
    return -1;
...
80105352:	78 79                	js     801053cd <sys_open+0xad>
  ...
  begin_op();
80105354:	e8 07 db ff ff       	call   80102e60 <begin_op>
...
80105397:	74 23                	je     801053bc <sys_open+0x9c>
  struct proc *curproc = myproc();
80105399:	e8 d2 e6 ff ff       	call   80103a70 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
8010539e:	31 db                	xor    %ebx,%ebx
    if(curproc->ofile[fd] == 0){
801053a0:	8b 54 98 2c          	mov    0x2c(%eax,%ebx,4),%edx
...
801053c0:	e8 4b c6 ff ff       	call   80101a10 <iunlockput>
    end_op();
801053c5:	e8 06 db ff ff       	call   80102ed0 <end_op>
    return -1;
...
801053f3:	75 99                	jne    8010538e <sys_open+0x6e>
      end_op();
801053f5:	e8 d6 da ff ff       	call   80102ed0 <end_op>
      return -1;
...
80105408:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
8010540b:	89 7c 98 2c          	mov    %edi,0x2c(%eax,%ebx,4)
  iunlock(ip);
8010540f:	56                   	push   %esi
80105410:	e8 4b c4 ff ff       	call   80101860 <iunlock>
  end_op();
80105415:	e8 b6 da ff ff       	call   80102ed0 <end_op>
...
80105463:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
80105466:	e8 f5 d9 ff ff       	call   80102e60 <begin_op>
...
8010549f:	e8 6c c5 ff ff       	call   80101a10 <iunlockput>
  end_op();
801054a4:	e8 27 da ff ff       	call   80102ed0 <end_op>
  return 0;
...
801054af:	c3                   	ret    
    end_op();
801054b0:	e8 1b da ff ff       	call   80102ed0 <end_op>
    return -1;
...
801054c3:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
801054c6:	e8 95 d9 ff ff       	call   80102e60 <begin_op>
  if((argstr(0, &path)) < 0 ||
...
8010552e:	e8 dd c4 ff ff       	call   80101a10 <iunlockput>
  end_op();
80105533:	e8 98 d9 ff ff       	call   80102ed0 <end_op>
  return 0;
...
8010553f:	90                   	nop
    end_op();
80105540:	e8 8b d9 ff ff       	call   80102ed0 <end_op>
    return -1;
...
80105555:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105558:	e8 13 e5 ff ff       	call   80103a70 <myproc>
8010555d:	89 c6                	mov    %eax,%esi
  
  begin_op();
8010555f:	e8 fc d8 ff ff       	call   80102e60 <begin_op>
...
801055a4:	e8 b7 c2 ff ff       	call   80101860 <iunlock>
  iput(curproc->cwd);
801055a9:	58                   	pop    %eax
801055aa:	ff 76 6c             	push   0x6c(%esi)
801055ad:	e8 fe c2 ff ff       	call   801018b0 <iput>
  end_op();
801055b2:	e8 19 d9 ff ff       	call   80102ed0 <end_op>
  curproc->cwd = ip;
801055b7:	89 5e 6c             	mov    %ebx,0x6c(%esi)
  return 0;
...
801055d4:	e8 37 c4 ff ff       	call   80101a10 <iunlockput>
    end_op();
801055d9:	e8 f2 d8 ff ff       	call   80102ed0 <end_op>
    return -1;
...
801055ef:	90                   	nop
    end_op();
801055f0:	e8 db d8 ff ff       	call   80102ed0 <end_op>
    return -1;
...
80105718:	e8 13 de ff ff       	call   80103530 <pipealloc>
...
80105727:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105729:	e8 42 e3 ff ff       	call   80103a70 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
8010572e:	66 90                	xchg   %ax,%ax
    if(curproc->ofile[fd] == 0){
80105730:	8b 74 98 2c          	mov    0x2c(%eax,%ebx,4),%esi
...
80105763:	89 7c b0 0c          	mov    %edi,0xc(%eax,%esi,4)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
...
80105771:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(curproc->ofile[fd] == 0){
80105778:	8b 4c 90 2c          	mov    0x2c(%eax,%edx,4),%ecx
...
801057d1:	e8 ca f2 ff ff       	call   80104aa0 <argptr>
...
801057e6:	e8 65 f2 ff ff       	call   80104a50 <argint>
...
801057f5:	ff 75 f4             	push   -0xc(%ebp)
801057f8:	ff 75 f0             	push   -0x10(%ebp)
801057fb:	e8 e0 c8 ff ff       	call   801020e0 <swapread>
	return 0;
...
80105831:	e8 6a f2 ff ff       	call   80104aa0 <argptr>
...
80105846:	e8 05 f2 ff ff       	call   80104a50 <argint>
...
80105858:	ff 75 f0             	push   -0x10(%ebp)
8010585b:	e8 00 c9 ff ff       	call   80102160 <swapwrite>
	return 0;
...
80105893:	83 ec 08             	sub    $0x8,%esp
  exit();
80105896:	e8 25 e6 ff ff       	call   80103ec0 <exit>
...
{
  return wait();
801058a0:	e9 4b e7 ff ff       	jmp    80103ff0 <wait>
...
801058ce:	e8 bd e9 ff ff       	call   80104290 <kill>
...
801058f3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801058f6:	e8 75 e1 ff ff       	call   80103a70 <myproc>
...
8010595d:	e8 ee f0 ff ff       	call   80104a50 <argint>
...
80105975:	e8 56 ed ff ff       	call   801046d0 <acquire>
  ticks0 = ticks;
...
8010599d:	e8 ce e7 ff ff       	call   80104170 <sleep>
  while(ticks - ticks0 < n){
...
801059af:	73 2f                	jae    801059e0 <sys_sleep+0x90>
    if(myproc()->killed){
801059b1:	e8 ba e0 ff ff       	call   80103a70 <myproc>
...
801059c5:	e8 a6 ec ff ff       	call   80104670 <release>
  }
  release(&tickslock);
  return 0;
}
...
801059e8:	e8 83 ec ff ff       	call   80104670 <release>
  return 0;
...
80105a67:	c7 04 c5 c2 3d 11 80 	movl   $0x8e000008,-0x7feec23e(,%eax,8)
80105a6e:	08 00 00 8e 
80105a72:	66 89 14 c5 c0 3d 11 	mov    %dx,-0x7feec240(,%eax,8)
80105a79:	80 
80105a7a:	c1 ea 10             	shr    $0x10,%edx
80105a7d:	66 89 14 c5 c6 3d 11 	mov    %dx,-0x7feec23a(,%eax,8)
80105a84:	80 
  for(i = 0; i < 256; i++)
...
80105a97:	c7 05 c2 3f 11 80 08 	movl   $0xef000008,0x80113fc2
80105a9e:	00 00 ef 
  initlock(&tickslock, "time");
80105aa1:	68 21 7b 10 80       	push   $0x80107b21
80105aa6:	68 80 3d 11 80       	push   $0x80113d80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105aab:	66 a3 c0 3f 11 80    	mov    %ax,0x80113fc0
80105ab1:	c1 e8 10             	shr    $0x10,%eax
80105ab4:	66 a3 c6 3f 11 80    	mov    %ax,0x80113fc6
  initlock(&tickslock, "time");
80105aba:	e8 41 ea ff ff       	call   80104500 <initlock>
}
...
80105adb:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105adf:	b8 c0 3d 11 80       	mov    $0x80113dc0,%eax
...
80105b12:	0f 84 30 01 00 00    	je     80105c48 <trap+0x148>
    if(myproc()->killed)
      exit();
    return;
  }
...
80105b1e:	77 70                	ja     80105b90 <trap+0x90>
80105b20:	ff 24 85 c8 7b 10 80 	jmp    *-0x7fef8438(,%eax,4)
...
80105b2e:	66 90                	xchg   %ax,%ax
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80105b30:	e8 0b c8 ff ff       	call   80102340 <ideintr>
    lapiceoi();
80105b35:	e8 d6 ce ff ff       	call   80102a10 <lapiceoi>
  }
...
80105b3a:	e8 31 df ff ff       	call   80103a70 <myproc>
80105b3f:	85 c0                	test   %eax,%eax
80105b41:	74 1d                	je     80105b60 <trap+0x60>
80105b43:	e8 28 df ff ff       	call   80103a70 <myproc>
80105b48:	8b 50 28             	mov    0x28(%eax),%edx
...
80105b5a:	0f 84 c0 01 00 00    	je     80105d20 <trap+0x220>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b60:	e8 0b df ff ff       	call   80103a70 <myproc>
80105b65:	85 c0                	test   %eax,%eax
80105b67:	74 1d                	je     80105b86 <trap+0x86>
80105b69:	e8 02 df ff ff       	call   80103a70 <myproc>
80105b6e:	8b 40 28             	mov    0x28(%eax),%eax
80105b71:	85 c0                	test   %eax,%eax
80105b73:	74 11                	je     80105b86 <trap+0x86>
80105b75:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105b79:	83 e0 03             	and    $0x3,%eax
80105b7c:	66 83 f8 03          	cmp    $0x3,%ax
80105b80:	0f 84 ef 00 00 00    	je     80105c75 <trap+0x175>
    exit();
}
...
80105b90:	e8 db de ff ff       	call   80103a70 <myproc>
80105b95:	8b 7b 38             	mov    0x38(%ebx),%edi
80105b98:	85 c0                	test   %eax,%eax
80105b9a:	0f 84 9a 01 00 00    	je     80105d3a <trap+0x23a>
80105ba0:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105ba4:	0f 84 90 01 00 00    	je     80105d3a <trap+0x23a>
...
80105bb0:	e8 9b de ff ff       	call   80103a50 <cpuid>
...
80105bc1:	e8 aa de ff ff       	call   80103a70 <myproc>
80105bc6:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105bc9:	e8 a2 de ff ff       	call   80103a70 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105bde:	83 c6 70             	add    $0x70,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105be1:	56                   	push   %esi
80105be2:	ff 70 10             	push   0x10(%eax)
80105be5:	68 84 7b 10 80       	push   $0x80107b84
80105bea:	e8 b1 aa ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
80105bef:	83 c4 20             	add    $0x20,%esp
80105bf2:	e8 79 de ff ff       	call   80103a70 <myproc>
80105bf7:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105bfe:	e8 6d de ff ff       	call   80103a70 <myproc>
80105c03:	85 c0                	test   %eax,%eax
80105c05:	0f 85 38 ff ff ff    	jne    80105b43 <trap+0x43>
80105c0b:	e9 50 ff ff ff       	jmp    80105b60 <trap+0x60>
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105c10:	8b 7b 38             	mov    0x38(%ebx),%edi
80105c13:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80105c17:	e8 34 de ff ff       	call   80103a50 <cpuid>
80105c1c:	57                   	push   %edi
80105c1d:	56                   	push   %esi
80105c1e:	50                   	push   %eax
80105c1f:	68 2c 7b 10 80       	push   $0x80107b2c
80105c24:	e8 77 aa ff ff       	call   801006a0 <cprintf>
    lapiceoi();
80105c29:	e8 e2 cd ff ff       	call   80102a10 <lapiceoi>
    break;
80105c2e:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c31:	e8 3a de ff ff       	call   80103a70 <myproc>
80105c36:	85 c0                	test   %eax,%eax
80105c38:	0f 85 05 ff ff ff    	jne    80105b43 <trap+0x43>
80105c3e:	e9 1d ff ff ff       	jmp    80105b60 <trap+0x60>
80105c43:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105c47:	90                   	nop
    if(myproc()->killed)
80105c48:	e8 23 de ff ff       	call   80103a70 <myproc>
80105c4d:	8b 70 28             	mov    0x28(%eax),%esi
80105c50:	85 f6                	test   %esi,%esi
80105c52:	0f 85 d8 00 00 00    	jne    80105d30 <trap+0x230>
    myproc()->tf = tf;
80105c58:	e8 13 de ff ff       	call   80103a70 <myproc>
80105c5d:	89 58 1c             	mov    %ebx,0x1c(%eax)
    syscall();
80105c60:	e8 2b ef ff ff       	call   80104b90 <syscall>
    if(myproc()->killed)
80105c65:	e8 06 de ff ff       	call   80103a70 <myproc>
80105c6a:	8b 48 28             	mov    0x28(%eax),%ecx
80105c6d:	85 c9                	test   %ecx,%ecx
80105c6f:	0f 84 11 ff ff ff    	je     80105b86 <trap+0x86>
}
...
80105c7b:	5d                   	pop    %ebp
      exit();
80105c7c:	e9 3f e2 ff ff       	jmp    80103ec0 <exit>
80105c81:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
80105c88:	e8 53 02 00 00       	call   80105ee0 <uartintr>
    lapiceoi();
80105c8d:	e8 7e cd ff ff       	call   80102a10 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c92:	e8 d9 dd ff ff       	call   80103a70 <myproc>
80105c97:	85 c0                	test   %eax,%eax
80105c99:	0f 85 a4 fe ff ff    	jne    80105b43 <trap+0x43>
80105c9f:	e9 bc fe ff ff       	jmp    80105b60 <trap+0x60>
80105ca4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80105ca8:	e8 23 cc ff ff       	call   801028d0 <kbdintr>
    lapiceoi();
80105cad:	e8 5e cd ff ff       	call   80102a10 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105cb2:	e8 b9 dd ff ff       	call   80103a70 <myproc>
80105cb7:	85 c0                	test   %eax,%eax
80105cb9:	0f 85 84 fe ff ff    	jne    80105b43 <trap+0x43>
80105cbf:	e9 9c fe ff ff       	jmp    80105b60 <trap+0x60>
80105cc4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80105cc8:	e8 83 dd ff ff       	call   80103a50 <cpuid>
80105ccd:	85 c0                	test   %eax,%eax
80105ccf:	0f 85 60 fe ff ff    	jne    80105b35 <trap+0x35>
      acquire(&tickslock);
80105cd5:	83 ec 0c             	sub    $0xc,%esp
80105cd8:	68 80 3d 11 80       	push   $0x80113d80
80105cdd:	e8 ee e9 ff ff       	call   801046d0 <acquire>
      ticks++;
80105ce2:	83 05 60 3d 11 80 01 	addl   $0x1,0x80113d60
	  if ( myproc() != 0 )
80105ce9:	e8 82 dd ff ff       	call   80103a70 <myproc>
80105cee:	83 c4 10             	add    $0x10,%esp
80105cf1:	85 c0                	test   %eax,%eax
80105cf3:	74 09                	je     80105cfe <trap+0x1fe>
	    myproc()->ticks++;
80105cf5:	e8 76 dd ff ff       	call   80103a70 <myproc>
80105cfa:	83 40 14 01          	addl   $0x1,0x14(%eax)
      wakeup(&ticks);
80105cfe:	83 ec 0c             	sub    $0xc,%esp
80105d01:	68 60 3d 11 80       	push   $0x80113d60
80105d06:	e8 25 e5 ff ff       	call   80104230 <wakeup>
      release(&tickslock);
80105d0b:	c7 04 24 80 3d 11 80 	movl   $0x80113d80,(%esp)
80105d12:	e8 59 e9 ff ff       	call   80104670 <release>
80105d17:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
80105d1a:	e9 16 fe ff ff       	jmp    80105b35 <trap+0x35>
80105d1f:	90                   	nop
    exit();
80105d20:	e8 9b e1 ff ff       	call   80103ec0 <exit>
80105d25:	e9 36 fe ff ff       	jmp    80105b60 <trap+0x60>
80105d2a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105d30:	e8 8b e1 ff ff       	call   80103ec0 <exit>
80105d35:	e9 1e ff ff ff       	jmp    80105c58 <trap+0x158>
80105d3a:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105d3d:	e8 0e dd ff ff       	call   80103a50 <cpuid>
80105d42:	83 ec 0c             	sub    $0xc,%esp
80105d45:	56                   	push   %esi
80105d46:	57                   	push   %edi
80105d47:	50                   	push   %eax
80105d48:	ff 73 30             	push   0x30(%ebx)
80105d4b:	68 50 7b 10 80       	push   $0x80107b50
80105d50:	e8 4b a9 ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105d55:	83 c4 14             	add    $0x14,%esp
80105d58:	68 26 7b 10 80       	push   $0x80107b26
80105d5d:	e8 1e a6 ff ff       	call   80100380 <panic>
...
80105df7:	74 78                	je     80105e71 <uartinit+0xd1>
  uart = 1;
80105df9:	c7 05 c0 45 11 80 01 	movl   $0x1,0x801145c0
80105e00:	00 00 00 
...
80105e0c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105e0f:	bf 48 7c 10 80       	mov    $0x80107c48,%edi
80105e14:	be fd 03 00 00       	mov    $0x3fd,%esi
  ioapicenable(IRQ_COM1, 0);
80105e19:	6a 00                	push   $0x0
80105e1b:	6a 04                	push   $0x4
80105e1d:	e8 5e c7 ff ff       	call   80102580 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
...
80105e45:	e8 e6 cb ff ff       	call   80102a30 <microdelay>
...
80105ea5:	e8 86 cb ff ff       	call   80102a30 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
...
80105ef7:	6a 00                	push   $0x0
  jmp alltraps
80105ef9:	e9 2c fb ff ff       	jmp    80105a2a <alltraps>
...
80105f00:	6a 01                	push   $0x1
  jmp alltraps
80105f02:	e9 23 fb ff ff       	jmp    80105a2a <alltraps>
...
80105f09:	6a 02                	push   $0x2
  jmp alltraps
80105f0b:	e9 1a fb ff ff       	jmp    80105a2a <alltraps>
...
80105f12:	6a 03                	push   $0x3
  jmp alltraps
80105f14:	e9 11 fb ff ff       	jmp    80105a2a <alltraps>
...
80105f1b:	6a 04                	push   $0x4
  jmp alltraps
80105f1d:	e9 08 fb ff ff       	jmp    80105a2a <alltraps>
...
80105f24:	6a 05                	push   $0x5
  jmp alltraps
80105f26:	e9 ff fa ff ff       	jmp    80105a2a <alltraps>
...
80105f2d:	6a 06                	push   $0x6
  jmp alltraps
80105f2f:	e9 f6 fa ff ff       	jmp    80105a2a <alltraps>
...
80105f36:	6a 07                	push   $0x7
  jmp alltraps
80105f38:	e9 ed fa ff ff       	jmp    80105a2a <alltraps>
...
80105f54:	6a 0b                	push   $0xb
  jmp alltraps
80105f56:	e9 cf fa ff ff       	jmp    80105a2a <alltraps>
...
80105f62:	6a 0d                	push   $0xd
  jmp alltraps
80105f64:	e9 c1 fa ff ff       	jmp    80105a2a <alltraps>
...
80105f69:	6a 0e                	push   $0xe
  jmp alltraps
80105f6b:	e9 ba fa ff ff       	jmp    80105a2a <alltraps>
...
80105f9d:	6a 14                	push   $0x14
  jmp alltraps
80105f9f:	e9 86 fa ff ff       	jmp    80105a2a <alltraps>
...
80105fa6:	6a 15                	push   $0x15
  jmp alltraps
80105fa8:	e9 7d fa ff ff       	jmp    80105a2a <alltraps>
...
80105faf:	6a 16                	push   $0x16
  jmp alltraps
80105fb1:	e9 74 fa ff ff       	jmp    80105a2a <alltraps>
...
80105fb8:	6a 17                	push   $0x17
  jmp alltraps
80105fba:	e9 6b fa ff ff       	jmp    80105a2a <alltraps>
...
80105fc1:	6a 18                	push   $0x18
  jmp alltraps
80105fc3:	e9 62 fa ff ff       	jmp    80105a2a <alltraps>
...
80105fca:	6a 19                	push   $0x19
  jmp alltraps
80105fcc:	e9 59 fa ff ff       	jmp    80105a2a <alltraps>
...
80105fd3:	6a 1a                	push   $0x1a
  jmp alltraps
80105fd5:	e9 50 fa ff ff       	jmp    80105a2a <alltraps>
...
80105fdc:	6a 1b                	push   $0x1b
  jmp alltraps
80105fde:	e9 47 fa ff ff       	jmp    80105a2a <alltraps>
...
80105fe5:	6a 1c                	push   $0x1c
  jmp alltraps
80105fe7:	e9 3e fa ff ff       	jmp    80105a2a <alltraps>
...
80105fee:	6a 1d                	push   $0x1d
  jmp alltraps
80105ff0:	e9 35 fa ff ff       	jmp    80105a2a <alltraps>
...
80105ff7:	6a 1e                	push   $0x1e
  jmp alltraps
80105ff9:	e9 2c fa ff ff       	jmp    80105a2a <alltraps>
...
80106000:	6a 1f                	push   $0x1f
  jmp alltraps
80106002:	e9 23 fa ff ff       	jmp    80105a2a <alltraps>
...
80106009:	6a 20                	push   $0x20
  jmp alltraps
8010600b:	e9 1a fa ff ff       	jmp    80105a2a <alltraps>
...
80106012:	6a 21                	push   $0x21
  jmp alltraps
80106014:	e9 11 fa ff ff       	jmp    80105a2a <alltraps>
...
8010601b:	6a 22                	push   $0x22
  jmp alltraps
8010601d:	e9 08 fa ff ff       	jmp    80105a2a <alltraps>
...
80106024:	6a 23                	push   $0x23
  jmp alltraps
80106026:	e9 ff f9 ff ff       	jmp    80105a2a <alltraps>
...
8010602d:	6a 24                	push   $0x24
  jmp alltraps
8010602f:	e9 f6 f9 ff ff       	jmp    80105a2a <alltraps>
...
80106036:	6a 25                	push   $0x25
  jmp alltraps
80106038:	e9 ed f9 ff ff       	jmp    80105a2a <alltraps>
...
8010603f:	6a 26                	push   $0x26
  jmp alltraps
80106041:	e9 e4 f9 ff ff       	jmp    80105a2a <alltraps>
...
80106048:	6a 27                	push   $0x27
  jmp alltraps
8010604a:	e9 db f9 ff ff       	jmp    80105a2a <alltraps>
...
80106051:	6a 28                	push   $0x28
  jmp alltraps
80106053:	e9 d2 f9 ff ff       	jmp    80105a2a <alltraps>
...
8010605a:	6a 29                	push   $0x29
  jmp alltraps
8010605c:	e9 c9 f9 ff ff       	jmp    80105a2a <alltraps>
...
80106063:	6a 2a                	push   $0x2a
  jmp alltraps
80106065:	e9 c0 f9 ff ff       	jmp    80105a2a <alltraps>
...
8010606c:	6a 2b                	push   $0x2b
  jmp alltraps
8010606e:	e9 b7 f9 ff ff       	jmp    80105a2a <alltraps>
...
80106075:	6a 2c                	push   $0x2c
  jmp alltraps
80106077:	e9 ae f9 ff ff       	jmp    80105a2a <alltraps>
...
8010607e:	6a 2d                	push   $0x2d
  jmp alltraps
80106080:	e9 a5 f9 ff ff       	jmp    80105a2a <alltraps>
...
80106087:	6a 2e                	push   $0x2e
  jmp alltraps
80106089:	e9 9c f9 ff ff       	jmp    80105a2a <alltraps>
...
80106090:	6a 2f                	push   $0x2f
  jmp alltraps
80106092:	e9 93 f9 ff ff       	jmp    80105a2a <alltraps>
...
80106099:	6a 30                	push   $0x30
  jmp alltraps
8010609b:	e9 8a f9 ff ff       	jmp    80105a2a <alltraps>
...
801060a2:	6a 31                	push   $0x31
  jmp alltraps
801060a4:	e9 81 f9 ff ff       	jmp    80105a2a <alltraps>
...
801060ab:	6a 32                	push   $0x32
  jmp alltraps
801060ad:	e9 78 f9 ff ff       	jmp    80105a2a <alltraps>
...
801060b4:	6a 33                	push   $0x33
  jmp alltraps
801060b6:	e9 6f f9 ff ff       	jmp    80105a2a <alltraps>
...
801060bd:	6a 34                	push   $0x34
  jmp alltraps
801060bf:	e9 66 f9 ff ff       	jmp    80105a2a <alltraps>
...
801060c6:	6a 35                	push   $0x35
  jmp alltraps
801060c8:	e9 5d f9 ff ff       	jmp    80105a2a <alltraps>
...
801060cf:	6a 36                	push   $0x36
  jmp alltraps
801060d1:	e9 54 f9 ff ff       	jmp    80105a2a <alltraps>
...
801060d8:	6a 37                	push   $0x37
  jmp alltraps
801060da:	e9 4b f9 ff ff       	jmp    80105a2a <alltraps>
...
801060e1:	6a 38                	push   $0x38
  jmp alltraps
801060e3:	e9 42 f9 ff ff       	jmp    80105a2a <alltraps>
...
801060ea:	6a 39                	push   $0x39
  jmp alltraps
801060ec:	e9 39 f9 ff ff       	jmp    80105a2a <alltraps>
...
801060f3:	6a 3a                	push   $0x3a
  jmp alltraps
801060f5:	e9 30 f9 ff ff       	jmp    80105a2a <alltraps>
...
801060fc:	6a 3b                	push   $0x3b
  jmp alltraps
801060fe:	e9 27 f9 ff ff       	jmp    80105a2a <alltraps>
...
80106105:	6a 3c                	push   $0x3c
  jmp alltraps
80106107:	e9 1e f9 ff ff       	jmp    80105a2a <alltraps>
...
8010610e:	6a 3d                	push   $0x3d
  jmp alltraps
80106110:	e9 15 f9 ff ff       	jmp    80105a2a <alltraps>
...
80106117:	6a 3e                	push   $0x3e
  jmp alltraps
80106119:	e9 0c f9 ff ff       	jmp    80105a2a <alltraps>
...
80106120:	6a 3f                	push   $0x3f
  jmp alltraps
80106122:	e9 03 f9 ff ff       	jmp    80105a2a <alltraps>
...
80106129:	6a 40                	push   $0x40
  jmp alltraps
8010612b:	e9 fa f8 ff ff       	jmp    80105a2a <alltraps>
...
80106132:	6a 41                	push   $0x41
  jmp alltraps
80106134:	e9 f1 f8 ff ff       	jmp    80105a2a <alltraps>
...
8010613b:	6a 42                	push   $0x42
  jmp alltraps
8010613d:	e9 e8 f8 ff ff       	jmp    80105a2a <alltraps>
...
80106144:	6a 43                	push   $0x43
  jmp alltraps
80106146:	e9 df f8 ff ff       	jmp    80105a2a <alltraps>
...
8010614d:	6a 44                	push   $0x44
  jmp alltraps
8010614f:	e9 d6 f8 ff ff       	jmp    80105a2a <alltraps>
...
80106156:	6a 45                	push   $0x45
  jmp alltraps
80106158:	e9 cd f8 ff ff       	jmp    80105a2a <alltraps>
...
8010615f:	6a 46                	push   $0x46
  jmp alltraps
80106161:	e9 c4 f8 ff ff       	jmp    80105a2a <alltraps>
...
80106168:	6a 47                	push   $0x47
  jmp alltraps
8010616a:	e9 bb f8 ff ff       	jmp    80105a2a <alltraps>
...
80106171:	6a 48                	push   $0x48
  jmp alltraps
80106173:	e9 b2 f8 ff ff       	jmp    80105a2a <alltraps>
...
8010617a:	6a 49                	push   $0x49
  jmp alltraps
8010617c:	e9 a9 f8 ff ff       	jmp    80105a2a <alltraps>
...
80106183:	6a 4a                	push   $0x4a
  jmp alltraps
80106185:	e9 a0 f8 ff ff       	jmp    80105a2a <alltraps>
...
8010618c:	6a 4b                	push   $0x4b
  jmp alltraps
8010618e:	e9 97 f8 ff ff       	jmp    80105a2a <alltraps>
...
80106195:	6a 4c                	push   $0x4c
  jmp alltraps
80106197:	e9 8e f8 ff ff       	jmp    80105a2a <alltraps>
...
8010619e:	6a 4d                	push   $0x4d
  jmp alltraps
801061a0:	e9 85 f8 ff ff       	jmp    80105a2a <alltraps>
...
801061a7:	6a 4e                	push   $0x4e
  jmp alltraps
801061a9:	e9 7c f8 ff ff       	jmp    80105a2a <alltraps>
...
801061b0:	6a 4f                	push   $0x4f
  jmp alltraps
801061b2:	e9 73 f8 ff ff       	jmp    80105a2a <alltraps>
...
801061b9:	6a 50                	push   $0x50
  jmp alltraps
801061bb:	e9 6a f8 ff ff       	jmp    80105a2a <alltraps>
...
801061c2:	6a 51                	push   $0x51
  jmp alltraps
801061c4:	e9 61 f8 ff ff       	jmp    80105a2a <alltraps>
...
801061cb:	6a 52                	push   $0x52
  jmp alltraps
801061cd:	e9 58 f8 ff ff       	jmp    80105a2a <alltraps>
...
801061d4:	6a 53                	push   $0x53
  jmp alltraps
801061d6:	e9 4f f8 ff ff       	jmp    80105a2a <alltraps>
...
801061dd:	6a 54                	push   $0x54
  jmp alltraps
801061df:	e9 46 f8 ff ff       	jmp    80105a2a <alltraps>
...
801061e6:	6a 55                	push   $0x55
  jmp alltraps
801061e8:	e9 3d f8 ff ff       	jmp    80105a2a <alltraps>
...
801061ef:	6a 56                	push   $0x56
  jmp alltraps
801061f1:	e9 34 f8 ff ff       	jmp    80105a2a <alltraps>
...
801061f8:	6a 57                	push   $0x57
  jmp alltraps
801061fa:	e9 2b f8 ff ff       	jmp    80105a2a <alltraps>
...
80106201:	6a 58                	push   $0x58
  jmp alltraps
80106203:	e9 22 f8 ff ff       	jmp    80105a2a <alltraps>
...
8010620a:	6a 59                	push   $0x59
  jmp alltraps
8010620c:	e9 19 f8 ff ff       	jmp    80105a2a <alltraps>
...
80106213:	6a 5a                	push   $0x5a
  jmp alltraps
80106215:	e9 10 f8 ff ff       	jmp    80105a2a <alltraps>
...
8010621c:	6a 5b                	push   $0x5b
  jmp alltraps
8010621e:	e9 07 f8 ff ff       	jmp    80105a2a <alltraps>
...
80106225:	6a 5c                	push   $0x5c
  jmp alltraps
80106227:	e9 fe f7 ff ff       	jmp    80105a2a <alltraps>
...
8010622e:	6a 5d                	push   $0x5d
  jmp alltraps
80106230:	e9 f5 f7 ff ff       	jmp    80105a2a <alltraps>
...
80106237:	6a 5e                	push   $0x5e
  jmp alltraps
80106239:	e9 ec f7 ff ff       	jmp    80105a2a <alltraps>
...
80106240:	6a 5f                	push   $0x5f
  jmp alltraps
80106242:	e9 e3 f7 ff ff       	jmp    80105a2a <alltraps>
...
80106249:	6a 60                	push   $0x60
  jmp alltraps
8010624b:	e9 da f7 ff ff       	jmp    80105a2a <alltraps>
...
80106252:	6a 61                	push   $0x61
  jmp alltraps
80106254:	e9 d1 f7 ff ff       	jmp    80105a2a <alltraps>
...
8010625b:	6a 62                	push   $0x62
  jmp alltraps
8010625d:	e9 c8 f7 ff ff       	jmp    80105a2a <alltraps>
...
80106264:	6a 63                	push   $0x63
  jmp alltraps
80106266:	e9 bf f7 ff ff       	jmp    80105a2a <alltraps>
...
8010626d:	6a 64                	push   $0x64
  jmp alltraps
8010626f:	e9 b6 f7 ff ff       	jmp    80105a2a <alltraps>
...
80106276:	6a 65                	push   $0x65
  jmp alltraps
80106278:	e9 ad f7 ff ff       	jmp    80105a2a <alltraps>
...
8010627f:	6a 66                	push   $0x66
  jmp alltraps
80106281:	e9 a4 f7 ff ff       	jmp    80105a2a <alltraps>
...
80106288:	6a 67                	push   $0x67
  jmp alltraps
8010628a:	e9 9b f7 ff ff       	jmp    80105a2a <alltraps>
...
80106291:	6a 68                	push   $0x68
  jmp alltraps
80106293:	e9 92 f7 ff ff       	jmp    80105a2a <alltraps>
...
8010629a:	6a 69                	push   $0x69
  jmp alltraps
8010629c:	e9 89 f7 ff ff       	jmp    80105a2a <alltraps>
...
801062a3:	6a 6a                	push   $0x6a
  jmp alltraps
801062a5:	e9 80 f7 ff ff       	jmp    80105a2a <alltraps>
...
801062ac:	6a 6b                	push   $0x6b
  jmp alltraps
801062ae:	e9 77 f7 ff ff       	jmp    80105a2a <alltraps>
...
801062b5:	6a 6c                	push   $0x6c
  jmp alltraps
801062b7:	e9 6e f7 ff ff       	jmp    80105a2a <alltraps>
...
801062be:	6a 6d                	push   $0x6d
  jmp alltraps
801062c0:	e9 65 f7 ff ff       	jmp    80105a2a <alltraps>
...
801062c7:	6a 6e                	push   $0x6e
  jmp alltraps
801062c9:	e9 5c f7 ff ff       	jmp    80105a2a <alltraps>
...
801062d0:	6a 6f                	push   $0x6f
  jmp alltraps
801062d2:	e9 53 f7 ff ff       	jmp    80105a2a <alltraps>
...
801062d9:	6a 70                	push   $0x70
  jmp alltraps
801062db:	e9 4a f7 ff ff       	jmp    80105a2a <alltraps>
...
801062e2:	6a 71                	push   $0x71
  jmp alltraps
801062e4:	e9 41 f7 ff ff       	jmp    80105a2a <alltraps>
...
801062eb:	6a 72                	push   $0x72
  jmp alltraps
801062ed:	e9 38 f7 ff ff       	jmp    80105a2a <alltraps>
...
801062f4:	6a 73                	push   $0x73
  jmp alltraps
801062f6:	e9 2f f7 ff ff       	jmp    80105a2a <alltraps>
...
801062fd:	6a 74                	push   $0x74
  jmp alltraps
801062ff:	e9 26 f7 ff ff       	jmp    80105a2a <alltraps>
...
80106306:	6a 75                	push   $0x75
  jmp alltraps
80106308:	e9 1d f7 ff ff       	jmp    80105a2a <alltraps>
...
8010630f:	6a 76                	push   $0x76
  jmp alltraps
80106311:	e9 14 f7 ff ff       	jmp    80105a2a <alltraps>
...
80106318:	6a 77                	push   $0x77
  jmp alltraps
8010631a:	e9 0b f7 ff ff       	jmp    80105a2a <alltraps>
...
80106321:	6a 78                	push   $0x78
  jmp alltraps
80106323:	e9 02 f7 ff ff       	jmp    80105a2a <alltraps>
...
8010632a:	6a 79                	push   $0x79
  jmp alltraps
8010632c:	e9 f9 f6 ff ff       	jmp    80105a2a <alltraps>
...
80106333:	6a 7a                	push   $0x7a
  jmp alltraps
80106335:	e9 f0 f6 ff ff       	jmp    80105a2a <alltraps>
...
8010633c:	6a 7b                	push   $0x7b
  jmp alltraps
8010633e:	e9 e7 f6 ff ff       	jmp    80105a2a <alltraps>
...
80106345:	6a 7c                	push   $0x7c
  jmp alltraps
80106347:	e9 de f6 ff ff       	jmp    80105a2a <alltraps>
...
8010634e:	6a 7d                	push   $0x7d
  jmp alltraps
80106350:	e9 d5 f6 ff ff       	jmp    80105a2a <alltraps>
...
80106357:	6a 7e                	push   $0x7e
  jmp alltraps
80106359:	e9 cc f6 ff ff       	jmp    80105a2a <alltraps>
...
80106360:	6a 7f                	push   $0x7f
  jmp alltraps
80106362:	e9 c3 f6 ff ff       	jmp    80105a2a <alltraps>
...
80106369:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010636e:	e9 b7 f6 ff ff       	jmp    80105a2a <alltraps>
...
80106375:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010637a:	e9 ab f6 ff ff       	jmp    80105a2a <alltraps>
...
80106381:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106386:	e9 9f f6 ff ff       	jmp    80105a2a <alltraps>
...
8010638d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106392:	e9 93 f6 ff ff       	jmp    80105a2a <alltraps>
...
80106399:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010639e:	e9 87 f6 ff ff       	jmp    80105a2a <alltraps>
...
801063a5:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801063aa:	e9 7b f6 ff ff       	jmp    80105a2a <alltraps>
...
801063b1:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801063b6:	e9 6f f6 ff ff       	jmp    80105a2a <alltraps>
...
801063bd:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801063c2:	e9 63 f6 ff ff       	jmp    80105a2a <alltraps>
...
801063c9:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801063ce:	e9 57 f6 ff ff       	jmp    80105a2a <alltraps>
...
801063d5:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801063da:	e9 4b f6 ff ff       	jmp    80105a2a <alltraps>
...
801063e1:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801063e6:	e9 3f f6 ff ff       	jmp    80105a2a <alltraps>
...
801063ed:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801063f2:	e9 33 f6 ff ff       	jmp    80105a2a <alltraps>
...
801063f9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801063fe:	e9 27 f6 ff ff       	jmp    80105a2a <alltraps>
...
80106405:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010640a:	e9 1b f6 ff ff       	jmp    80105a2a <alltraps>
...
80106411:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106416:	e9 0f f6 ff ff       	jmp    80105a2a <alltraps>
...
8010641d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106422:	e9 03 f6 ff ff       	jmp    80105a2a <alltraps>
...
80106429:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010642e:	e9 f7 f5 ff ff       	jmp    80105a2a <alltraps>
...
80106435:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010643a:	e9 eb f5 ff ff       	jmp    80105a2a <alltraps>
...
80106441:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106446:	e9 df f5 ff ff       	jmp    80105a2a <alltraps>
...
8010644d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106452:	e9 d3 f5 ff ff       	jmp    80105a2a <alltraps>
...
80106459:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010645e:	e9 c7 f5 ff ff       	jmp    80105a2a <alltraps>
...
80106465:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010646a:	e9 bb f5 ff ff       	jmp    80105a2a <alltraps>
...
80106471:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106476:	e9 af f5 ff ff       	jmp    80105a2a <alltraps>
...
8010647d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106482:	e9 a3 f5 ff ff       	jmp    80105a2a <alltraps>
...
80106489:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010648e:	e9 97 f5 ff ff       	jmp    80105a2a <alltraps>
...
80106495:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010649a:	e9 8b f5 ff ff       	jmp    80105a2a <alltraps>
...
801064a1:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801064a6:	e9 7f f5 ff ff       	jmp    80105a2a <alltraps>
...
801064ad:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801064b2:	e9 73 f5 ff ff       	jmp    80105a2a <alltraps>
...
801064b9:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801064be:	e9 67 f5 ff ff       	jmp    80105a2a <alltraps>
...
801064c5:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801064ca:	e9 5b f5 ff ff       	jmp    80105a2a <alltraps>
...
801064d1:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801064d6:	e9 4f f5 ff ff       	jmp    80105a2a <alltraps>
...
801064dd:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801064e2:	e9 43 f5 ff ff       	jmp    80105a2a <alltraps>
...
801064e9:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801064ee:	e9 37 f5 ff ff       	jmp    80105a2a <alltraps>
...
801064f5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801064fa:	e9 2b f5 ff ff       	jmp    80105a2a <alltraps>
...
80106501:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106506:	e9 1f f5 ff ff       	jmp    80105a2a <alltraps>
...
8010650d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106512:	e9 13 f5 ff ff       	jmp    80105a2a <alltraps>
...
80106519:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010651e:	e9 07 f5 ff ff       	jmp    80105a2a <alltraps>
...
80106525:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010652a:	e9 fb f4 ff ff       	jmp    80105a2a <alltraps>
...
80106531:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106536:	e9 ef f4 ff ff       	jmp    80105a2a <alltraps>
...
8010653d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106542:	e9 e3 f4 ff ff       	jmp    80105a2a <alltraps>
...
80106549:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010654e:	e9 d7 f4 ff ff       	jmp    80105a2a <alltraps>
...
80106555:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010655a:	e9 cb f4 ff ff       	jmp    80105a2a <alltraps>
...
80106561:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106566:	e9 bf f4 ff ff       	jmp    80105a2a <alltraps>
...
8010656d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106572:	e9 b3 f4 ff ff       	jmp    80105a2a <alltraps>
...
80106579:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010657e:	e9 a7 f4 ff ff       	jmp    80105a2a <alltraps>
...
80106585:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010658a:	e9 9b f4 ff ff       	jmp    80105a2a <alltraps>
...
80106591:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106596:	e9 8f f4 ff ff       	jmp    80105a2a <alltraps>
...
8010659d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801065a2:	e9 83 f4 ff ff       	jmp    80105a2a <alltraps>
...
801065a9:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801065ae:	e9 77 f4 ff ff       	jmp    80105a2a <alltraps>
...
801065b5:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801065ba:	e9 6b f4 ff ff       	jmp    80105a2a <alltraps>
...
801065c1:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801065c6:	e9 5f f4 ff ff       	jmp    80105a2a <alltraps>
...
801065cd:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801065d2:	e9 53 f4 ff ff       	jmp    80105a2a <alltraps>
...
801065d9:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801065de:	e9 47 f4 ff ff       	jmp    80105a2a <alltraps>
...
801065e5:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801065ea:	e9 3b f4 ff ff       	jmp    80105a2a <alltraps>
...
801065f1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801065f6:	e9 2f f4 ff ff       	jmp    80105a2a <alltraps>
...
801065fd:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106602:	e9 23 f4 ff ff       	jmp    80105a2a <alltraps>
...
80106609:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010660e:	e9 17 f4 ff ff       	jmp    80105a2a <alltraps>
...
80106615:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010661a:	e9 0b f4 ff ff       	jmp    80105a2a <alltraps>
...
80106621:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106626:	e9 ff f3 ff ff       	jmp    80105a2a <alltraps>
...
8010662d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106632:	e9 f3 f3 ff ff       	jmp    80105a2a <alltraps>
...
80106639:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010663e:	e9 e7 f3 ff ff       	jmp    80105a2a <alltraps>
...
80106645:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010664a:	e9 db f3 ff ff       	jmp    80105a2a <alltraps>
...
80106651:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106656:	e9 cf f3 ff ff       	jmp    80105a2a <alltraps>
...
8010665d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106662:	e9 c3 f3 ff ff       	jmp    80105a2a <alltraps>
...
80106669:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010666e:	e9 b7 f3 ff ff       	jmp    80105a2a <alltraps>
...
80106675:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010667a:	e9 ab f3 ff ff       	jmp    80105a2a <alltraps>
...
80106681:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106686:	e9 9f f3 ff ff       	jmp    80105a2a <alltraps>
...
8010668d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106692:	e9 93 f3 ff ff       	jmp    80105a2a <alltraps>
...
80106699:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010669e:	e9 87 f3 ff ff       	jmp    80105a2a <alltraps>
...
801066a5:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801066aa:	e9 7b f3 ff ff       	jmp    80105a2a <alltraps>
...
801066b1:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801066b6:	e9 6f f3 ff ff       	jmp    80105a2a <alltraps>
...
801066bd:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801066c2:	e9 63 f3 ff ff       	jmp    80105a2a <alltraps>
...
801066c9:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801066ce:	e9 57 f3 ff ff       	jmp    80105a2a <alltraps>
...
801066d5:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801066da:	e9 4b f3 ff ff       	jmp    80105a2a <alltraps>
...
801066e1:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801066e6:	e9 3f f3 ff ff       	jmp    80105a2a <alltraps>
...
801066ed:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801066f2:	e9 33 f3 ff ff       	jmp    80105a2a <alltraps>
...
801066f9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801066fe:	e9 27 f3 ff ff       	jmp    80105a2a <alltraps>
...
80106705:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010670a:	e9 1b f3 ff ff       	jmp    80105a2a <alltraps>
...
80106711:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106716:	e9 0f f3 ff ff       	jmp    80105a2a <alltraps>
...
8010671d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106722:	e9 03 f3 ff ff       	jmp    80105a2a <alltraps>
...
80106729:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010672e:	e9 f7 f2 ff ff       	jmp    80105a2a <alltraps>
...
80106735:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010673a:	e9 eb f2 ff ff       	jmp    80105a2a <alltraps>
...
80106741:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106746:	e9 df f2 ff ff       	jmp    80105a2a <alltraps>
...
8010674d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106752:	e9 d3 f2 ff ff       	jmp    80105a2a <alltraps>
...
80106759:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010675e:	e9 c7 f2 ff ff       	jmp    80105a2a <alltraps>
...
80106765:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010676a:	e9 bb f2 ff ff       	jmp    80105a2a <alltraps>
...
80106771:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106776:	e9 af f2 ff ff       	jmp    80105a2a <alltraps>
...
8010677d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106782:	e9 a3 f2 ff ff       	jmp    80105a2a <alltraps>
...
80106789:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010678e:	e9 97 f2 ff ff       	jmp    80105a2a <alltraps>
...
80106795:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010679a:	e9 8b f2 ff ff       	jmp    80105a2a <alltraps>
...
801067a1:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801067a6:	e9 7f f2 ff ff       	jmp    80105a2a <alltraps>
...
801067ad:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801067b2:	e9 73 f2 ff ff       	jmp    80105a2a <alltraps>
...
801067b9:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801067be:	e9 67 f2 ff ff       	jmp    80105a2a <alltraps>
...
801067c5:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801067ca:	e9 5b f2 ff ff       	jmp    80105a2a <alltraps>
...
801067d1:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801067d6:	e9 4f f2 ff ff       	jmp    80105a2a <alltraps>
...
801067dd:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801067e2:	e9 43 f2 ff ff       	jmp    80105a2a <alltraps>
...
801067e9:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801067ee:	e9 37 f2 ff ff       	jmp    80105a2a <alltraps>
...
801067f5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801067fa:	e9 2b f2 ff ff       	jmp    80105a2a <alltraps>
...
80106801:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106806:	e9 1f f2 ff ff       	jmp    80105a2a <alltraps>
...
8010680d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106812:	e9 13 f2 ff ff       	jmp    80105a2a <alltraps>
...
80106819:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010681e:	e9 07 f2 ff ff       	jmp    80105a2a <alltraps>
...
80106825:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010682a:	e9 fb f1 ff ff       	jmp    80105a2a <alltraps>
...
80106831:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106836:	e9 ef f1 ff ff       	jmp    80105a2a <alltraps>
...
8010683d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106842:	e9 e3 f1 ff ff       	jmp    80105a2a <alltraps>
...
80106849:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010684e:	e9 d7 f1 ff ff       	jmp    80105a2a <alltraps>
...
80106855:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010685a:	e9 cb f1 ff ff       	jmp    80105a2a <alltraps>
...
80106861:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106866:	e9 bf f1 ff ff       	jmp    80105a2a <alltraps>
...
8010686d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106872:	e9 b3 f1 ff ff       	jmp    80105a2a <alltraps>
...
80106879:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010687e:	e9 a7 f1 ff ff       	jmp    80105a2a <alltraps>
...
80106885:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010688a:	e9 9b f1 ff ff       	jmp    80105a2a <alltraps>
...
80106891:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106896:	e9 8f f1 ff ff       	jmp    80105a2a <alltraps>
...
8010689d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801068a2:	e9 83 f1 ff ff       	jmp    80105a2a <alltraps>
...
801068a9:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801068ae:	e9 77 f1 ff ff       	jmp    80105a2a <alltraps>
...
801068b5:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801068ba:	e9 6b f1 ff ff       	jmp    80105a2a <alltraps>
...
801068c1:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801068c6:	e9 5f f1 ff ff       	jmp    80105a2a <alltraps>
...
801068cd:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801068d2:	e9 53 f1 ff ff       	jmp    80105a2a <alltraps>
...
801068d9:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801068de:	e9 47 f1 ff ff       	jmp    80105a2a <alltraps>
...
801068e5:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801068ea:	e9 3b f1 ff ff       	jmp    80105a2a <alltraps>
...
801068f1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801068f6:	e9 2f f1 ff ff       	jmp    80105a2a <alltraps>
...
801068fd:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106902:	e9 23 f1 ff ff       	jmp    80105a2a <alltraps>
...
80106909:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010690e:	e9 17 f1 ff ff       	jmp    80105a2a <alltraps>
...
80106915:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010691a:	e9 0b f1 ff ff       	jmp    80105a2a <alltraps>
...
80106921:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106926:	e9 ff f0 ff ff       	jmp    80105a2a <alltraps>
...
8010692d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106932:	e9 f3 f0 ff ff       	jmp    80105a2a <alltraps>
...
80106939:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010693e:	e9 e7 f0 ff ff       	jmp    80105a2a <alltraps>
...
80106945:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010694a:	e9 db f0 ff ff       	jmp    80105a2a <alltraps>
...
80106951:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106956:	e9 cf f0 ff ff       	jmp    80105a2a <alltraps>
...
8010695d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106962:	e9 c3 f0 ff ff       	jmp    80105a2a <alltraps>
...
801069f9:	e8 c2 bb ff ff       	call   801025c0 <kfree>
      *pte = 0;
...
80106a0f:	68 e2 75 10 80       	push   $0x801075e2
...
80106a9e:	e8 dd bc ff ff       	call   80102780 <kalloc>
...
80106ab5:	e8 d6 dc ff ff       	call   80104790 <memset>
...
80106afd:	68 50 7c 10 80       	push   $0x80107c50
...
80106b13:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106b16:	e8 35 cf ff ff       	call   80103a50 <cpuid>
  pd[0] = size-1;
...
80106bd4:	0f 84 c2 00 00 00    	je     80106c9c <switchuvm+0xec>
  pushcli();
80106bda:	e8 a1 d9 ff ff       	call   80104580 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106bdf:	e8 0c ce ff ff       	call   801039f0 <mycpu>
80106be4:	89 c3                	mov    %eax,%ebx
80106be6:	e8 05 ce ff ff       	call   801039f0 <mycpu>
80106beb:	89 c7                	mov    %eax,%edi
80106bed:	e8 fe cd ff ff       	call   801039f0 <mycpu>
80106bf2:	83 c7 08             	add    $0x8,%edi
80106bf5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106bf8:	e8 f3 cd ff ff       	call   801039f0 <mycpu>
...
80106cdb:	77 4b                	ja     80106d28 <inituvm+0x68>
  mem = kalloc();
80106cdd:	e8 9e ba ff ff       	call   80102780 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106cef:	e8 9c da ff ff       	call   80104790 <memset>
...
80106d22:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106d23:	e9 08 db ff ff       	jmp    80104830 <memmove>
    panic("inituvm: more than a page");
80106d28:	83 ec 0c             	sub    $0xc,%esp
80106d2b:	68 95 7c 10 80       	push   $0x80107c95
...
80106d90:	68 af 7c 10 80       	push   $0x80107caf
...
80106e18:	68 50 7d 10 80       	push   $0x80107d50
...
80106e7b:	e8 10 d9 ff ff       	call   80104790 <memset>
...
80106ea9:	76 48                	jbe    80106ef3 <allocuvm+0xc3>
    mem = kalloc();
80106eab:	e8 d0 b8 ff ff       	call   80102780 <kalloc>
...
80106eb9:	68 cd 7c 10 80       	push   $0x80107ccd
...
80106f1b:	68 e5 7c 10 80       	push   $0x80107ce5
...
80106f40:	e8 7b b6 ff ff       	call   801025c0 <kfree>
      return 0;
...
80106fde:	e8 dd b5 ff ff       	call   801025c0 <kfree>
...
80106ff3:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106ff4:	e9 c7 b5 ff ff       	jmp    801025c0 <kfree>
    panic("freevm: no pgdir");
80106ff9:	83 ec 0c             	sub    $0xc,%esp
80106ffc:	68 01 7d 10 80       	push   $0x80107d01
...
80107015:	e8 66 b7 ff ff       	call   80102780 <kalloc>
...
80107030:	e8 5b d7 ff ff       	call   80104790 <memset>
...
801070cc:	68 12 7d 10 80       	push   $0x80107d12
...
80107142:	68 1c 7d 10 80       	push   $0x80107d1c
...
8010717f:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80107185:	e8 f6 b5 ff ff       	call   80102780 <kalloc>
...
801071a0:	e8 8b d6 ff ff       	call   80104830 <memmove>
...
801071ec:	e8 cf b3 ff ff       	call   801025c0 <kfree>
      goto bad;
...
80107217:	68 36 7d 10 80       	push   $0x80107d36
...
801072d0:	e8 5b d5 ff ff       	call   80104830 <memmove>
    len -= n;
    buf += n;
