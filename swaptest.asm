   ...
   f:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  25:	68 00 10 00 00       	push   $0x1000
	blkno = atoi(argv[1]);
  2a:	89 c3                	mov    %eax,%ebx
	memset(buffer1, '1', 4096);
  2c:	6a 31                	push   $0x31
  2e:	68 e0 1a 00 00       	push   $0x1ae0
  33:	e8 38 01 00 00       	call   170 <memset>

	swapwrite(buffer1, blkno);
  38:	58                   	pop    %eax
  39:	5a                   	pop    %edx
  3a:	53                   	push   %ebx
  3b:	68 e0 1a 00 00       	push   $0x1ae0
  40:	e8 66 03 00 00       	call   3ab <swapwrite>

	swapread(buffer2, blkno);
  45:	59                   	pop    %ecx
  46:	58                   	pop    %eax
  47:	53                   	push   %ebx
  48:	68 e0 0a 00 00       	push   $0xae0

	for ( i=0; i <4096; ++i ) {
  4d:	31 db                	xor    %ebx,%ebx
	swapread(buffer2, blkno);
  4f:	e8 4f 03 00 00       	call   3a3 <swapread>
  ...
  8b:	75 d3                	jne    60 <main+0x60>
	...
	exit();
  8d:	e8 71 02 00 00       	call   303 <exit>
		printf(1, "Usage: %s blkno\n", argv[0]);
  92:	52                   	push   %edx
  93:	ff 30                	push   (%eax)
  95:	68 98 07 00 00       	push   $0x798
  9a:	6a 01                	push   $0x1
  9c:	e8 cf 03 00 00       	call   470 <printf>
		exit();
 ...
 479:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4e9:	ff 24 85 c4 07 00 00 	jmp    *0x7c4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5f7:	90                   	nop
          s = "(null)";
 5f8:	ba ba 07 00 00       	mov    $0x7ba,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 611:	a1 e0 2a 00 00       	mov    0x2ae0,%eax
{
 ...
 651:	5b                   	pop    %ebx
  freep = p;
 652:	89 15 e0 2a 00 00    	mov    %edx,0x2ae0
}
 658:	5e                   	pop    %esi
 659:	5f                   	pop    %edi
 65a:	5d                   	pop    %ebp
 ...
 689:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 68c:	89 15 e0 2a 00 00    	mov    %edx,0x2ae0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 3d e0 2a 00 00    	mov    0x2ae0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ef:	73 4f                	jae    740 <malloc+0xa0>
    ...
    if(p == freep)
 6f1:	8b 3d e0 2a 00 00    	mov    0x2ae0,%edi
 ...
 71a:	e8 f1 fe ff ff       	call   610 <free>
  return freep;
 71f:	8b 15 e0 2a 00 00    	mov    0x2ae0,%edx
 ...
 74c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 74f:	89 15 e0 2a 00 00    	mov    %edx,0x2ae0
}
 ...
 75f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 760:	c7 05 e0 2a 00 00 e4 	movl   $0x2ae4,0x2ae0
 767:	2a 00 00 
    base.s.size = 0;
 76a:	bf e4 2a 00 00       	mov    $0x2ae4,%edi
    base.s.ptr = freep = prevp = &base;
 76f:	c7 05 e4 2a 00 00 e4 	movl   $0x2ae4,0x2ae4
 776:	2a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 779:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 77b:	c7 05 e8 2a 00 00 00 	movl   $0x0,0x2ae8
 782:	00 00 00 
    if(p->s.size >= nunits){
